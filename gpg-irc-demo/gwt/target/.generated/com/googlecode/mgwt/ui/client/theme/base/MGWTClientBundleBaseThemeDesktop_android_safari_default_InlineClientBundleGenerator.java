...
public class MGWTClientBundleBaseThemeDesktop_android_safari_default_InlineClientBundleGenerator implements com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeDesktop {
  ...
  private void getButtonBarCssInitializer() {
    getButtonBarCss = new com.googlecode.mgwt.ui.client.theme.base.ButtonBarCss() {
      ...
      public String getText() {
        return (".mgwt-ButtonBar{overflow:" + ("hidden")  + ";width:" + ("100%")  + ";position:" + ("relative")  + ";display:" + ("-webkit-box")  + ";-webkit-box-orient:" + ("horizontal")  + ";height:" + ("49px")  + ";border-top:" + ("1px"+ " " +"solid"+ " " +"#2d3642")  + ";background:" + ("-webkit-gradient(linear,left bottom,left top,color-stop(0, #A8ACB9),color-stop(1, #eee))")  + ";}.GOE-WOTBCK{margin-top:" + ("14px")  + ";white-space:" + ("nowrap")  + ";overflow:") + (("hidden")  + ";text-overflow:" + ("ellipsis")  + ";text-align:" + ("center")  + ";font-size:" + ("12px")  + ";font-weight:" + ("bold")  + ";text-shadow:" + ("0"+ " " +"1px"+ " " +"0"+ " " +"#333")  + ";color:" + ("white")  + ";}.GOE-WOTBBK{-webkit-box-flex:" + ("1")  + ";}");
      }
  ...
  private void getLayoutCssInitializer() {
    getLayoutCss = new com.googlecode.mgwt.ui.client.theme.base.LayoutCss() {
      ...
      public String getText() {
        return (".GOE-WOTBAO{display:" + ("-webkit-box")  + ";-webkit-box-orient:" + ("vertical")  + ";width:" + ("100%")  + ";height:" + ("100%")  + ";}.GOE-WOTBCO{-webkit-box-orient:" + ("horizontal")  + ";}.GOE-WOTBBO{-webkit-box-flex:" + ("1")  + ";}");
      }
