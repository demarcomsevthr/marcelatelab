...
public class MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator implements com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone {
  private static MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator _instance0 = new MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator();
  ...
  private void getButtonBarCssInitializer() {
    getButtonBarCss = new com.googlecode.mgwt.ui.client.theme.base.ButtonBarCss() {
      ...
      public String getText() {
        return (".mgwt-ButtonBar{overflow:" + ("hidden")  + ";width:" + ("100%")  + ";position:" + ("relative")  + ";display:" + ("-moz-box")  + ";-moz-box-orient:" + ("horizontal")  + ";height:" + ("49px")  + ";border-top:" + ("1px"+ " " +"solid"+ " " +"#2d3642")  + ";background-image:" + ("-moz-linear-gradient(top, rgba(176, 188, 205, 1), rgba(129, 149, 175, 1))")  + ";}.GOE-WOTBCK{margin-top:" + ("14px")  + ";white-space:" + ("nowrap")  + ";overflow:") + (("hidden")  + ";text-overflow:" + ("ellipsis")  + ";text-align:" + ("center")  + ";font-size:" + ("12px")  + ";font-weight:" + ("bold")  + ";text-shadow:" + ("0"+ " " +"1px"+ " " +"0"+ " " +"#333")  + ";color:" + ("white")  + ";}.GOE-WOTBBK{-moz-box-flex:" + ("1")  + ";}");
      }
  ...
  private void getButtonCssInitializer() {
    getButtonCss = new com.googlecode.mgwt.ui.client.theme.base.ButtonCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".mgwt-Button{display:" + ("block")  + ";position:" + ("relative")  + ";padding:" + ("9px"+ " " +"13px")  + ";margin:" + ("5px")  + ";white-space:" + ("nowrap")  + ";overflow:" + ("hidden")  + ";text-overflow:" + ("ellipsis")  + ";font-size:" + ("19px")  + ";text-align:" + ("center")  + ";-moz-appearance:" + ("none")  + ";}.mgwt-Button-small{padding:") + (("5px"+ " " +"7px")  + ";margin:" + ("2px")  + ";margin-right:" + ("5px")  + ";margin-left:" + ("5px")  + ";font-size:" + ("12px")  + ";}.mgwt-Button-round{border-bottom-right-radius:" + ("16px"+ " " +"16px")  + ";border-bottom-left-radius:" + ("16px"+ " " +"16px")  + ";border-top-right-radius:" + ("16px"+ " " +"16px")  + ";border-top-left-radius:" + ("16px"+ " " +"16px")  + ";}.mgwt-Button{border:" + ("solid"+ " " +"1px"+ " " +"rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0.5" + ")")  + ";color:" + ("#000") ) + (";font-weight:" + ("bold")  + ";-moz-border-radius:" + ("6px")  + ";border-radius:" + ("6px")  + ";background-image:" + ("-webkit-linear-gradient(top, rgba(234,234,234,0.90), rgba(195,195,195,0.70) 50%, rgba(166,166,166,0.70) 51%, rgba(167,167,167,0.80))")  + ";}.mgwt-Button-active{color:" + ("#fff")  + ";background-image:" + ("-moz-linear-gradient(top, rgb(5, 140, 245),  rgba(5, 140, 245,0.70) 50%, rgba(1, 95, 230,0.70) 51% , rgb(1, 95, 230) )")  + ";-moz-box-shadow:" + ("inset"+ " " +"rgba(" + "207"+ ","+ " " +"207"+ ","+ " " +"255"+ ","+ " " +"0.75" + ")"+ " " +"0"+ " " +"1px"+ " " +"1px")  + ";}.mgwt-Button-important{color:" + ("#fff")  + ";background-image:" + ("-moz-linear-gradient(top, rgba(255,59,59,0.70), rgba(233,72,72,0.80) 50%, rgba(184,0,0,0.70) 51%, rgba(255,0,0,0.80))")  + ";}.mgwt-Button-important.mgwt-Button-active{background-image:" + ("-moz-linear-gradient(ltop, rgba(255,30,30,1), rgba(233,40,40,1) 50%, rgba(184,0,0,1) 51%, rgba(255,0,0,1))")  + ";}.mgwt-Button-confirm{color:") + (("#fff")  + ";background-image:" + ("-moz-linear-gradient(top, rgba(115,239,115,0.70), rgba(73,171,14,0.60) 50%, rgba(0,113,0,0.70) 51%, rgba(0,150,0,0.80))")  + ";}.mgwt-Button-confirm.mgwt-Button-active{background-image:" + ("-moz-linear-gradient(top, rgba(80,200,80,1), rgba(50,150,0,1) 50%, rgba(0,100,0,1) 51%, rgba(0,80,0,1))")  + ";}.mgwt-Button-round{border-bottom-right-radius:" + ("16px"+ " " +"16px")  + ";border-bottom-left-radius:" + ("16px"+ " " +"16px")  + ";border-top-right-radius:" + ("16px"+ " " +"16px")  + ";border-top-left-radius:" + ("16px"+ " " +"16px")  + ";}")) : ((".mgwt-Button{display:" + ("block")  + ";position:" + ("relative")  + ";padding:" + ("9px"+ " " +"13px")  + ";margin:" + ("5px")  + ";white-space:" + ("nowrap")  + ";overflow:" + ("hidden")  + ";text-overflow:" + ("ellipsis")  + ";font-size:" + ("19px")  + ";text-align:" + ("center")  + ";-moz-appearance:" + ("none")  + ";}.mgwt-Button-small{padding:") + (("5px"+ " " +"7px")  + ";margin:" + ("2px")  + ";margin-left:" + ("5px")  + ";margin-right:" + ("5px")  + ";font-size:" + ("12px")  + ";}.mgwt-Button-round{border-bottom-left-radius:" + ("16px"+ " " +"16px")  + ";border-bottom-right-radius:" + ("16px"+ " " +"16px")  + ";border-top-left-radius:" + ("16px"+ " " +"16px")  + ";border-top-right-radius:" + ("16px"+ " " +"16px")  + ";}.mgwt-Button{border:" + ("solid"+ " " +"1px"+ " " +"rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0.5" + ")")  + ";color:" + ("#000") ) + (";font-weight:" + ("bold")  + ";-moz-border-radius:" + ("6px")  + ";border-radius:" + ("6px")  + ";background-image:" + ("-webkit-linear-gradient(top, rgba(234,234,234,0.90), rgba(195,195,195,0.70) 50%, rgba(166,166,166,0.70) 51%, rgba(167,167,167,0.80))")  + ";}.mgwt-Button-active{color:" + ("#fff")  + ";background-image:" + ("-moz-linear-gradient(top, rgb(5, 140, 245),  rgba(5, 140, 245,0.70) 50%, rgba(1, 95, 230,0.70) 51% , rgb(1, 95, 230) )")  + ";-moz-box-shadow:" + ("inset"+ " " +"rgba(" + "207"+ ","+ " " +"207"+ ","+ " " +"255"+ ","+ " " +"0.75" + ")"+ " " +"0"+ " " +"1px"+ " " +"1px")  + ";}.mgwt-Button-important{color:" + ("#fff")  + ";background-image:" + ("-moz-linear-gradient(top, rgba(255,59,59,0.70), rgba(233,72,72,0.80) 50%, rgba(184,0,0,0.70) 51%, rgba(255,0,0,0.80))")  + ";}.mgwt-Button-important.mgwt-Button-active{background-image:" + ("-moz-linear-gradient(ltop, rgba(255,30,30,1), rgba(233,40,40,1) 50%, rgba(184,0,0,1) 51%, rgba(255,0,0,1))")  + ";}.mgwt-Button-confirm{color:") + (("#fff")  + ";background-image:" + ("-moz-linear-gradient(top, rgba(115,239,115,0.70), rgba(73,171,14,0.60) 50%, rgba(0,113,0,0.70) 51%, rgba(0,150,0,0.80))")  + ";}.mgwt-Button-confirm.mgwt-Button-active{background-image:" + ("-moz-linear-gradient(top, rgba(80,200,80,1), rgba(50,150,0,1) 50%, rgba(0,100,0,1) 51%, rgba(0,80,0,1))")  + ";}.mgwt-Button-round{border-bottom-left-radius:" + ("16px"+ " " +"16px")  + ";border-bottom-right-radius:" + ("16px"+ " " +"16px")  + ";border-top-left-radius:" + ("16px"+ " " +"16px")  + ";border-top-right-radius:" + ("16px"+ " " +"16px")  + ";}"));
      }
      public java.lang.String active(){
  ...
  private void getCarouselCssInitializer() {
    getCarouselCss = new com.googlecode.mgwt.ui.client.theme.base.CarouselCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".mgwt-Carousel{position:" + ("relative")  + ";display:" + ("-moz-box")  + ";-moz-box-flex:" + ("1")  + ";}.mgwt-Carousel-Scroller{-moz-box-flex:" + ("1")  + ";}.mgwt-Carousel-Container{display:" + ("-moz-box")  + ";-moz-box-flex:" + ("1")  + ";}.mgwt-Carousel-Indicator-Container{position:" + ("absolute")  + ";left:" + ("0")  + ";right:" + ("0")  + ";bottom:" + ("0")  + ";display:") + (("-moz-box")  + ";-moz-box-pack:" + ("center")  + ";}.mgwt-Carousel-Indicator{width:" + ("8px")  + ";height:" + ("8px")  + ";background-color:" + ("#d3d3d3")  + ";border-radius:" + ("4px")  + ";margin:" + ("4px")  + ";}.mgwt-Carousel-Indicator-active{background-color:" + ("#757575")  + ";}.mgwt-Carousel-Holder{position:" + ("relative")  + ";display:" + ("-moz-box")  + ";}")) : ((".mgwt-Carousel{position:" + ("relative")  + ";display:" + ("-moz-box")  + ";-moz-box-flex:" + ("1")  + ";}.mgwt-Carousel-Scroller{-moz-box-flex:" + ("1")  + ";}.mgwt-Carousel-Container{display:" + ("-moz-box")  + ";-moz-box-flex:" + ("1")  + ";}.mgwt-Carousel-Indicator-Container{position:" + ("absolute")  + ";right:" + ("0")  + ";left:" + ("0")  + ";bottom:" + ("0")  + ";display:") + (("-moz-box")  + ";-moz-box-pack:" + ("center")  + ";}.mgwt-Carousel-Indicator{width:" + ("8px")  + ";height:" + ("8px")  + ";background-color:" + ("#d3d3d3")  + ";border-radius:" + ("4px")  + ";margin:" + ("4px")  + ";}.mgwt-Carousel-Indicator-active{background-color:" + ("#757575")  + ";}.mgwt-Carousel-Holder{position:" + ("relative")  + ";display:" + ("-moz-box")  + ";}"));
      }
  ...
  private void getCheckBoxCssInitializer() {
    getCheckBoxCss = new com.googlecode.mgwt.ui.client.theme.base.CheckBoxCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".mgwt-CheckBox{width:" + ("94px")  + ";overflow:" + ("hidden")  + ";text-align:" + ("center")  + ";line-height:" + ("28px")  + ";cursor:" + ("pointer")  + ";width:" + ("88px")  + ";line-height:" + ("27px")  + ";display:" + ("-moz-box")  + ";-moz-box-orient:" + ("horizontal")  + ";-moz-box-pack:" + ("justify")  + ";-moz-tap-highlight-color:") + (("transparent")  + ";-moz-border-radius:" + ("6px")  + ";border-radius:" + ("6px")  + ";-moz-box-sizing:" + ("border-box")  + ";}.mgwt-CheckBox-middle{position:" + ("relative")  + ";z-index:" + ("1")  + ";border:" + ("solid"+ " " +"1px"+ " " +"#929292")  + ";-moz-transition:" + ("all"+ " " +"0.1s"+ " " +"ease-in-out")  + ";-moz-border-radius:" + ("6px")  + ";border-radius:" + ("6px")  + ";}.mgwt-CheckBox-middle-content{display:" + ("block") ) + (";position:" + ("relative")  + ";height:" + ("25px")  + ";width:" + ("38px")  + ";border-top:" + ("solid"+ " " +"1px"+ " " +"#eee")  + ";-moz-box-sizing:" + ("border-box")  + ";background-image:" + ("-moz-linear-gradient(top, #cecece, #fcfcfc )")  + ";-moz-border-radius:" + ("5px")  + ";border-radius:" + ("5px")  + ";}.mgwt-CheckBox-on{position:" + ("relative")  + ";height:" + ("25px")  + ";color:") + (("#fff")  + ";margin-left:" + ("-6px")  + ";width:" + ("54px")  + ";padding-left:" + ("4px")  + ";border:" + ("solid"+ " " +"1px"+ " " +"#093888")  + ";background-image:" + ("-moz-linear-gradient(top, #295ab3, #76adfb )")  + ";-moz-border-radius-bottomleft:" + ("6px")  + ";-moz-border-radius-topleft:" + ("6px")  + ";border-radius-bottomleft:" + ("6px")  + ";border-radius-topleft:" + ("6px")  + ";-moz-transition:" + ("all"+ " " +"0.1s"+ " " +"ease-in-out") ) + (";}.mgwt-CheckBox-off{position:" + ("relative")  + ";color:" + ("#666")  + ";width:" + ("54px")  + ";padding-right:" + ("4px")  + ";border:" + ("solid"+ " " +"1px"+ " " +"#a2a2a2")  + ";margin-right:" + ("-6px")  + ";height:" + ("25px")  + ";background-image:" + ("-moz-linear-gradient(top, #b6b6b6, #fff 50% )")  + ";-moz-border-radius-topright:" + ("6px")  + ";-moz-border-radius-bottomright:" + ("6px")  + ";border-radius-topright:") + (("6px")  + ";border-radius-bottomright:" + ("6px")  + ";-moz-transition:" + ("all"+ " " +"0.1s"+ " " +"ease-in-out")  + ";}.mgwt-CheckBox-important .mgwt-CheckBox-on{background-image:" + ("-moz-linear-gradient(top, #e75f00, #fe9c12 50% )")  + ";border:" + ("solid"+ " " +"1px"+ " " +"#d87101")  + ";}.mgwt-CheckBox-notchecked .mgwt-CheckBox-middle{-moz-transform:" + ("translate(" + "-54px"+ ","+ " " +"0" + ")")  + ";}.mgwt-CheckBox-checked .mgwt-CheckBox-middle{-moz-transform:" + ("translate(" + "0"+ ","+ " " +"0" + ")")  + ";}.mgwt-CheckBox-notchecked .mgwt-CheckBox-off{-moz-transform:" + ("translate(" + "-54px"+ ","+ " " +"0" + ")")  + ";}.mgwt-CheckBox-checked .mgwt-CheckBox-off{-moz-transform:" + ("translate(" + "0"+ ","+ " " +"0" + ")")  + ";}.mgwt-CheckBox-notchecked .mgwt-CheckBox-on{-moz-transform:" + ("translate(" + "-62px"+ ","+ " " +"0" + ")")  + ";}.mgwt-CheckBox-checked .mgwt-CheckBox-on{-moz-transform:" + ("translate(" + "0"+ ","+ " " +"0" + ")") ) + (";}")) : ((".mgwt-CheckBox{width:" + ("94px")  + ";overflow:" + ("hidden")  + ";text-align:" + ("center")  + ";line-height:" + ("28px")  + ";cursor:" + ("pointer")  + ";width:" + ("88px")  + ";line-height:" + ("27px")  + ";display:" + ("-moz-box")  + ";-moz-box-orient:" + ("horizontal")  + ";-moz-box-pack:" + ("justify")  + ";-moz-tap-highlight-color:") + (("transparent")  + ";-moz-border-radius:" + ("6px")  + ";border-radius:" + ("6px")  + ";-moz-box-sizing:" + ("border-box")  + ";}.mgwt-CheckBox-middle{position:" + ("relative")  + ";z-index:" + ("1")  + ";border:" + ("solid"+ " " +"1px"+ " " +"#929292")  + ";-moz-transition:" + ("all"+ " " +"0.1s"+ " " +"ease-in-out")  + ";-moz-border-radius:" + ("6px")  + ";border-radius:" + ("6px")  + ";}.mgwt-CheckBox-middle-content{display:" + ("block") ) + (";position:" + ("relative")  + ";height:" + ("25px")  + ";width:" + ("38px")  + ";border-top:" + ("solid"+ " " +"1px"+ " " +"#eee")  + ";-moz-box-sizing:" + ("border-box")  + ";background-image:" + ("-moz-linear-gradient(top, #cecece, #fcfcfc )")  + ";-moz-border-radius:" + ("5px")  + ";border-radius:" + ("5px")  + ";}.mgwt-CheckBox-on{position:" + ("relative")  + ";height:" + ("25px")  + ";color:") + (("#fff")  + ";margin-right:" + ("-6px")  + ";width:" + ("54px")  + ";padding-right:" + ("4px")  + ";border:" + ("solid"+ " " +"1px"+ " " +"#093888")  + ";background-image:" + ("-moz-linear-gradient(top, #295ab3, #76adfb )")  + ";-moz-border-radius-bottomleft:" + ("6px")  + ";-moz-border-radius-topleft:" + ("6px")  + ";border-radius-bottomleft:" + ("6px")  + ";border-radius-topleft:" + ("6px")  + ";-moz-transition:" + ("all"+ " " +"0.1s"+ " " +"ease-in-out") ) + (";}.mgwt-CheckBox-off{position:" + ("relative")  + ";color:" + ("#666")  + ";width:" + ("54px")  + ";padding-left:" + ("4px")  + ";border:" + ("solid"+ " " +"1px"+ " " +"#a2a2a2")  + ";margin-left:" + ("-6px")  + ";height:" + ("25px")  + ";background-image:" + ("-moz-linear-gradient(top, #b6b6b6, #fff 50% )")  + ";-moz-border-radius-topright:" + ("6px")  + ";-moz-border-radius-bottomright:" + ("6px")  + ";border-radius-topright:") + (("6px")  + ";border-radius-bottomright:" + ("6px")  + ";-moz-transition:" + ("all"+ " " +"0.1s"+ " " +"ease-in-out")  + ";}.mgwt-CheckBox-important .mgwt-CheckBox-on{background-image:" + ("-moz-linear-gradient(top, #e75f00, #fe9c12 50% )")  + ";border:" + ("solid"+ " " +"1px"+ " " +"#d87101")  + ";}.mgwt-CheckBox-notchecked .mgwt-CheckBox-middle{-moz-transform:" + ("translate(" + "-54px"+ ","+ " " +"0" + ")")  + ";}.mgwt-CheckBox-checked .mgwt-CheckBox-middle{-moz-transform:" + ("translate(" + "0"+ ","+ " " +"0" + ")")  + ";}.mgwt-CheckBox-notchecked .mgwt-CheckBox-off{-moz-transform:" + ("translate(" + "-54px"+ ","+ " " +"0" + ")")  + ";}.mgwt-CheckBox-checked .mgwt-CheckBox-off{-moz-transform:" + ("translate(" + "0"+ ","+ " " +"0" + ")")  + ";}.mgwt-CheckBox-notchecked .mgwt-CheckBox-on{-moz-transform:" + ("translate(" + "-62px"+ ","+ " " +"0" + ")")  + ";}.mgwt-CheckBox-checked .mgwt-CheckBox-on{-moz-transform:" + ("translate(" + "0"+ ","+ " " +"0" + ")") ) + (";}"));
      }
  ...
  private void getDialogCssInitializer() {
    getDialogCss = new com.googlecode.mgwt.ui.client.theme.base.DialogCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".z_index{z-index:" + ("100")  + ";}.mgwt-DialogAnimationContainer-Shadow{z-index:" + ("100")  + ";background-color:" + ("rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0.4" + ")")  + ";}.mgwt-DialogAnimationContainer-center{-moz-box-orient:" + ("horizontal")  + ";-moz-box-pack:" + ("center")  + ";-moz-box-align:" + ("center")  + ";display:" + ("-moz-box")  + ";width:" + ("100%")  + ";height:" + ("100%")  + ";}.mgwt-BottomPanel{position:" + ("absolute")  + ";bottom:") + (("0")  + ";right:" + ("0")  + ";left:" + ("0")  + ";background-color:" + ("rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0.9" + ")")  + ";background-image:" + ("-webkit-gradient(linear, 0% 0, 0% 100%, from(rgba(50, 74, 103, 0.9)), color-stop(0.02, rgba(20, 25, 35, 0.9) ), to(rgba(0, 0, 0, 0.0) ) )")  + ";border-top:" + ("1px"+ " " +"solid"+ " " +"#030506")  + ";padding:" + ("10px")  + ";}.mgwt-DialogPanel{border:" + ("solid"+ " " +"1px"+ " " +"#72767b")  + ";padding:" + ("0")  + ";opacity:" + ("1")  + ";border-radius:" + ("10px") ) + (";-moz-box-shadow:" + ("0"+ " " +"4px"+ " " +"6px"+ " " +"#666"+ ","+ " " +"0"+ " " +"0"+ " " +"50px"+ " " +"rgba(" + "255"+ ","+ " " +"255"+ ","+ " " +"255"+ ","+ " " +"1" + ")")  + ";background-image:" + ("-moz-linear-gradient(top, rgba(0, 15, 70, 0.5), rgba(0, 0, 70, 0.5))")  + ";}.mgwt-DialogPanel .container{color:" + ("#fff")  + ";text-shadow:" + ("0"+ " " +"-1px"+ " " +"1px"+ " " +"#000")  + ";border:" + ("solid"+ " " +"2px"+ " " +"#e6e6ee")  + ";padding:" + ("5px")  + ";-moz-border-radius:" + ("10px")  + ";border-radius:" + ("10px")  + ";padding:" + ("5px")  + ";}.mgwt-DialogPanel .title{-webkit-border-top-left-radius:" + ("10px")  + ";-webkit-border-top-right-radius:") + (("10px")  + ";color:" + ("#fff")  + ";background:" + ("none")  + ";border:" + ("none")  + ";text-shadow:" + ("0"+ " " +"-2px"+ " " +"1px"+ " " +"#000")  + ";width:" + ("100%")  + ";text-align:" + ("center")  + ";font-size:" + ("19px")  + ";margin-bottom:" + ("20px")  + ";-moz-border-radius-topright:" + ("10px")  + ";-moz-border-radius-topleft:" + ("10px") ) + (";border-radius-topright:" + ("10px")  + ";border-radius-topleft:" + ("10px")  + ";}.mgwt-DialogPanel .content{margin:" + ("10px")  + ";}.mgwt-DialogPanel .footer{margin-top:" + ("10px")  + ";-moz-box-pack:" + ("justify")  + ";display:" + ("-moz-box")  + ";-moz-box-orient:" + ("horizontal")  + ";-moz-box-sizing:" + ("border-box")  + ";width:" + ("100%")  + ";}.mgwt-DialogPanel .okbutton{display:" + ("block")  + ";font-size:") + (("17px")  + ";font-weight:" + ("bold")  + ";text-align:" + ("center")  + ";margin-top:" + ("10px")  + ";margin-left:" + ("5px")  + ";padding-left:" + ("5px")  + ";padding-right:" + ("5px")  + ";min-width:" + ("40px")  + ";height:" + ("32px")  + ";line-height:" + ("32px")  + ";text-shadow:" + ("0"+ " " +"-2px"+ " " +"1px"+ " " +"#000") ) + (";-moz-box-flex:" + ("2")  + ";-moz-border-radius:" + ("8px")  + ";border-radius:" + ("8px")  + ";background-image:" + ("-moz-linear-gradient(top, #b0b5c5,#7a839b 50%, #515d7c 51%, #636e8a)")  + ";}.mgwt-DialogPanel .cancelbutton{display:" + ("block")  + ";font-size:" + ("17px")  + ";font-weight:" + ("bold")  + ";text-align:" + ("center")  + ";margin-top:" + ("10px")  + ";margin-left:" + ("5px")  + ";padding-left:") + (("5px")  + ";padding-right:" + ("5px")  + ";min-width:" + ("40px")  + ";height:" + ("32px")  + ";line-height:" + ("32px")  + ";text-shadow:" + ("0"+ " " +"-2px"+ " " +"1px"+ " " +"#000")  + ";-moz-box-flex:" + ("2")  + ";-moz-border-radius:" + ("8px")  + ";border-radius:" + ("8px")  + ";background-image:" + ("-moz-linear-gradient(top, #828ba3, #4c5a7c 50%, #27375f 51%, #2e3d64 )")  + ";}.mgwt-DialogPanel .cancelbutton.active,.mgwt-DialogPanel .okbutton.active{background-image:" + ("-moz-linear-gradient(top, #70747f, #424857 50%, #171e30 51%, #222839)") ) + (";}")) : ((".z_index{z-index:" + ("100")  + ";}.mgwt-DialogAnimationContainer-Shadow{z-index:" + ("100")  + ";background-color:" + ("rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0.4" + ")")  + ";}.mgwt-DialogAnimationContainer-center{-moz-box-orient:" + ("horizontal")  + ";-moz-box-pack:" + ("center")  + ";-moz-box-align:" + ("center")  + ";display:" + ("-moz-box")  + ";width:" + ("100%")  + ";height:" + ("100%")  + ";}.mgwt-BottomPanel{position:" + ("absolute")  + ";bottom:") + (("0")  + ";left:" + ("0")  + ";right:" + ("0")  + ";background-color:" + ("rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0.9" + ")")  + ";background-image:" + ("-webkit-gradient(linear, 0% 0, 0% 100%, from(rgba(50, 74, 103, 0.9)), color-stop(0.02, rgba(20, 25, 35, 0.9) ), to(rgba(0, 0, 0, 0.0) ) )")  + ";border-top:" + ("1px"+ " " +"solid"+ " " +"#030506")  + ";padding:" + ("10px")  + ";}.mgwt-DialogPanel{border:" + ("solid"+ " " +"1px"+ " " +"#72767b")  + ";padding:" + ("0")  + ";opacity:" + ("1")  + ";border-radius:" + ("10px") ) + (";-moz-box-shadow:" + ("0"+ " " +"4px"+ " " +"6px"+ " " +"#666"+ ","+ " " +"0"+ " " +"0"+ " " +"50px"+ " " +"rgba(" + "255"+ ","+ " " +"255"+ ","+ " " +"255"+ ","+ " " +"1" + ")")  + ";background-image:" + ("-moz-linear-gradient(top, rgba(0, 15, 70, 0.5), rgba(0, 0, 70, 0.5))")  + ";}.mgwt-DialogPanel .container{color:" + ("#fff")  + ";text-shadow:" + ("0"+ " " +"-1px"+ " " +"1px"+ " " +"#000")  + ";border:" + ("solid"+ " " +"2px"+ " " +"#e6e6ee")  + ";padding:" + ("5px")  + ";-moz-border-radius:" + ("10px")  + ";border-radius:" + ("10px")  + ";padding:" + ("5px")  + ";}.mgwt-DialogPanel .title{-webkit-border-top-right-radius:" + ("10px")  + ";-webkit-border-top-left-radius:") + (("10px")  + ";color:" + ("#fff")  + ";background:" + ("none")  + ";border:" + ("none")  + ";text-shadow:" + ("0"+ " " +"-2px"+ " " +"1px"+ " " +"#000")  + ";width:" + ("100%")  + ";text-align:" + ("center")  + ";font-size:" + ("19px")  + ";margin-bottom:" + ("20px")  + ";-moz-border-radius-topright:" + ("10px")  + ";-moz-border-radius-topleft:" + ("10px") ) + (";border-radius-topright:" + ("10px")  + ";border-radius-topleft:" + ("10px")  + ";}.mgwt-DialogPanel .content{margin:" + ("10px")  + ";}.mgwt-DialogPanel .footer{margin-top:" + ("10px")  + ";-moz-box-pack:" + ("justify")  + ";display:" + ("-moz-box")  + ";-moz-box-orient:" + ("horizontal")  + ";-moz-box-sizing:" + ("border-box")  + ";width:" + ("100%")  + ";}.mgwt-DialogPanel .okbutton{display:" + ("block")  + ";font-size:") + (("17px")  + ";font-weight:" + ("bold")  + ";text-align:" + ("center")  + ";margin-top:" + ("10px")  + ";margin-right:" + ("5px")  + ";padding-right:" + ("5px")  + ";padding-left:" + ("5px")  + ";min-width:" + ("40px")  + ";height:" + ("32px")  + ";line-height:" + ("32px")  + ";text-shadow:" + ("0"+ " " +"-2px"+ " " +"1px"+ " " +"#000") ) + (";-moz-box-flex:" + ("2")  + ";-moz-border-radius:" + ("8px")  + ";border-radius:" + ("8px")  + ";background-image:" + ("-moz-linear-gradient(top, #b0b5c5,#7a839b 50%, #515d7c 51%, #636e8a)")  + ";}.mgwt-DialogPanel .cancelbutton{display:" + ("block")  + ";font-size:" + ("17px")  + ";font-weight:" + ("bold")  + ";text-align:" + ("center")  + ";margin-top:" + ("10px")  + ";margin-right:" + ("5px")  + ";padding-right:") + (("5px")  + ";padding-left:" + ("5px")  + ";min-width:" + ("40px")  + ";height:" + ("32px")  + ";line-height:" + ("32px")  + ";text-shadow:" + ("0"+ " " +"-2px"+ " " +"1px"+ " " +"#000")  + ";-moz-box-flex:" + ("2")  + ";-moz-border-radius:" + ("8px")  + ";border-radius:" + ("8px")  + ";background-image:" + ("-moz-linear-gradient(top, #828ba3, #4c5a7c 50%, #27375f 51%, #2e3d64 )")  + ";}.mgwt-DialogPanel .cancelbutton.active,.mgwt-DialogPanel .okbutton.active{background-image:" + ("-moz-linear-gradient(top, #70747f, #424857 50%, #171e30 51%, #222839)") ) + (";}"));
      }
      public java.lang.String active(){
        return "active";
      }
  ...
  private void getGroupingListInitializer() {
    getGroupingList = new com.googlecode.mgwt.ui.client.theme.base.GroupingList() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".mgwt-GroupingList{position:" + ("relative")  + ";overflow:" + ("hidden")  + ";display:" + ("-moz-box")  + ";}.mgwt-GroupingList-Moving-Header{position:" + ("absolute")  + ";top:" + ("0")  + ";right:" + ("0")  + ";left:" + ("0")  + ";}.mgwt-GroupingList-Selection-Bar{position:" + ("absolute")  + ";top:" + ("20px")  + ";left:" + ("5px")  + ";bottom:") + (("20px")  + ";z-index:" + ("1")  + ";padding:" + ("5px")  + ";display:" + ("-moz-box")  + ";-moz-box-orient:" + ("vertical")  + ";}.mgwt-GroupingList-Selection-Bar>li{list-style-type:" + ("none")  + ";font-size:" + ("8pt")  + ";font-weight:" + ("bolder")  + ";-moz-box-flex:" + ("1")  + ";color:" + ("#555")  + ";}.mgwt-GroupingList-Selection-Bar-active{border-radius:" + ("10px") ) + (";background:" + ("rgba(" + "100"+ ","+ " " +"100"+ ","+ " " +"100"+ ","+ " " +"0.5" + ")")  + ";}")) : ((".mgwt-GroupingList{position:" + ("relative")  + ";overflow:" + ("hidden")  + ";display:" + ("-moz-box")  + ";}.mgwt-GroupingList-Moving-Header{position:" + ("absolute")  + ";top:" + ("0")  + ";left:" + ("0")  + ";right:" + ("0")  + ";}.mgwt-GroupingList-Selection-Bar{position:" + ("absolute")  + ";top:" + ("20px")  + ";right:" + ("5px")  + ";bottom:") + (("20px")  + ";z-index:" + ("1")  + ";padding:" + ("5px")  + ";display:" + ("-moz-box")  + ";-moz-box-orient:" + ("vertical")  + ";}.mgwt-GroupingList-Selection-Bar>li{list-style-type:" + ("none")  + ";font-size:" + ("8pt")  + ";font-weight:" + ("bolder")  + ";-moz-box-flex:" + ("1")  + ";color:" + ("#555")  + ";}.mgwt-GroupingList-Selection-Bar-active{border-radius:" + ("10px") ) + (";background:" + ("rgba(" + "100"+ ","+ " " +"100"+ ","+ " " +"100"+ ","+ " " +"0.5" + ")")  + ";}"));
      }
  ...
  private void getInputCssInitializer() {
    getInputCss = new com.googlecode.mgwt.ui.client.theme.base.InputCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".mgwt-TextBox .mgwt-InputBox-box,.mgwt-PasswordTextBox .mgwt-InputBox-box,.mgwt-TextArea .mgwt-InputBox-box{color:" + ("#777")  + ";border:" + ("0")  + ";font:" + ("normal"+ " " +"17px"+ " " +"Helvetica")  + ";padding:" + ("0")  + ";display:" + ("inline-block")  + ";margin-right:" + ("0")  + ";-webkit-appearance:" + ("none")  + ";-moz-appearance:" + ("none")  + ";-webkit-user-select:" + ("text")  + ";-moz-user-select:" + ("text")  + ";-webkit-tap-highlight-color:") + (("rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0" + ")")  + ";-webkit-user-modify:" + ("read-write-plaintext-only")  + ";}.mgwt-TextBox .mgwt-InputBox-box,.mgwt-PasswordTextBox .mgwt-InputBox-box,.mgwt-TextArea .mgwt-InputBox-box{display:" + ("-moz-box")  + ";-moz-box-flex:" + ("1")  + ";}.mgwt-TextBox,.mgwt-PasswordTextBox,.mgwt-TextArea{position:" + ("relative")  + ";display:" + ("-moz-box")  + ";-moz-box-flex:" + ("1")  + ";}.mgwt-RadioButton{position:" + ("relative")  + ";display:" + ("-moz-box")  + ";-moz-box-orient:" + ("horizontal")  + ";width:" + ("100%") ) + (";-moz-box-flex:" + ("1")  + ";}.mgwt-RadioButton>label{display:" + ("-moz-box")  + ";position:" + ("relative")  + ";-moz-box-flex:" + ("1")  + ";}.mgwt-ListBox{color:" + ("#777")  + ";border:" + ("0")  + ";font:" + ("normal"+ " " +"17px"+ " " +"Helvetica")  + ";padding:" + ("0")  + ";margin-right:" + ("0")  + ";width:" + ("100%")  + ";height:") + (("100%")  + ";display:" + ("-moz-box")  + ";-moz-appearance:" + ("none")  + ";-moz-user-select:" + ("text")  + ";}.mgwt-RadioButton>input{width:" + ("18px")  + ";height:" + ("18px")  + ";border:" + ("none")  + ";background-color:" + ("transparent")  + ";background-image:" + ("url('" + ((com.google.gwt.resources.client.DataResource)(MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator.this.inputCheckImage())).getUrl() + "')")  + ";opacity:" + ("0.2")  + ";-moz-appearance:" + ("none") ) + (" !important;}.mgwt-RadioButton>input:CHECKED{background-image:" + ("url('" + ((com.google.gwt.resources.client.DataResource)(MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator.this.inputCheckImage())).getUrl() + "')")  + ";opacity:" + ("1")  + ";background-color:" + ("transparent")  + ";-moz-appearance:" + ("none")  + " !important;}")) : ((".mgwt-TextBox .mgwt-InputBox-box,.mgwt-PasswordTextBox .mgwt-InputBox-box,.mgwt-TextArea .mgwt-InputBox-box{color:" + ("#777")  + ";border:" + ("0")  + ";font:" + ("normal"+ " " +"17px"+ " " +"Helvetica")  + ";padding:" + ("0")  + ";display:" + ("inline-block")  + ";margin-left:" + ("0")  + ";-webkit-appearance:" + ("none")  + ";-moz-appearance:" + ("none")  + ";-webkit-user-select:" + ("text")  + ";-moz-user-select:" + ("text")  + ";-webkit-tap-highlight-color:") + (("rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0" + ")")  + ";-webkit-user-modify:" + ("read-write-plaintext-only")  + ";}.mgwt-TextBox .mgwt-InputBox-box,.mgwt-PasswordTextBox .mgwt-InputBox-box,.mgwt-TextArea .mgwt-InputBox-box{display:" + ("-moz-box")  + ";-moz-box-flex:" + ("1")  + ";}.mgwt-TextBox,.mgwt-PasswordTextBox,.mgwt-TextArea{position:" + ("relative")  + ";display:" + ("-moz-box")  + ";-moz-box-flex:" + ("1")  + ";}.mgwt-RadioButton{position:" + ("relative")  + ";display:" + ("-moz-box")  + ";-moz-box-orient:" + ("horizontal")  + ";width:" + ("100%") ) + (";-moz-box-flex:" + ("1")  + ";}.mgwt-RadioButton>label{display:" + ("-moz-box")  + ";position:" + ("relative")  + ";-moz-box-flex:" + ("1")  + ";}.mgwt-ListBox{color:" + ("#777")  + ";border:" + ("0")  + ";font:" + ("normal"+ " " +"17px"+ " " +"Helvetica")  + ";padding:" + ("0")  + ";margin-left:" + ("0")  + ";width:" + ("100%")  + ";height:") + (("100%")  + ";display:" + ("-moz-box")  + ";-moz-appearance:" + ("none")  + ";-moz-user-select:" + ("text")  + ";}.mgwt-RadioButton>input{width:" + ("18px")  + ";height:" + ("18px")  + ";border:" + ("none")  + ";background-color:" + ("transparent")  + ";background-image:" + ("url('" + ((com.google.gwt.resources.client.DataResource)(MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator.this.inputCheckImage())).getUrl() + "')")  + ";opacity:" + ("0.2")  + ";-moz-appearance:" + ("none") ) + (" !important;}.mgwt-RadioButton>input:CHECKED{background-image:" + ("url('" + ((com.google.gwt.resources.client.DataResource)(MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator.this.inputCheckImage())).getUrl() + "')")  + ";opacity:" + ("1")  + ";background-color:" + ("transparent")  + ";-moz-appearance:" + ("none")  + " !important;}"));
      }
  ...
  private void getLayoutCssInitializer() {
    getLayoutCss = new com.googlecode.mgwt.ui.client.theme.base.LayoutCss() {
      ...
      public String getText() {
        return (".GOE-WOTBAO{display:" + ("-moz-box")  + ";-moz-box-orient:" + ("vertical")  + ";width:" + ("100%")  + ";height:" + ("100%")  + ";overflow:" + ("hidden")  + ";vertical-align:" + ("top")  + ";}.GOE-WOTBCO{-moz-box-orient:" + ("horizontal")  + ";}.GOE-WOTBAO>.GOE-WOTBBO{-moz-box-flex:" + ("1")  + ";overflow:" + ("hidden")  + ";}.GOE-WOTBBO{-moz-box-flex:" + ("1")  + ";}");
      }
  ...
  private void getMainCssInitializer() {
    getMainCss = new com.googlecode.mgwt.ui.client.theme.base.MainCss() {
      ...
      public String getText() {
        return ("*{margin:" + ("0")  + ";padding:" + ("0")  + ";font-family:" + ("Helvetica"+ ","+ " " +"sans-serif")  + ";-moz-user-select:" + ("none")  + ";}input,textarea{-moz-user-select:" + ("text")  + ";}body{width:" + ("100%")  + ";height:" + ("100%")  + ";position:" + ("absolute")  + ";background-color:" + ("#c5ccd4")  + ";background-size:" + ("7px"+ " " +"7px")  + ";background-repeat:") + (("repeat")  + ";background-image:" + ("-moz-linear-gradient(left, #C5CCD4, #C5CCD4 60%, #CBD2D8 61%, #CBD2D8)")  + ";}");
      }
    }
    ;
  }
  ...
  private void getPanelCssInitializer() {
    getPanelCss = new com.googlecode.mgwt.ui.client.theme.base.PanelCss() {
      ...
      public String getText() {
        return (".mgwt-RoundPanel{border-radius:" + ("15px")  + ";background-color:" + ("white")  + ";border:" + ("1px"+ " " +"solid"+ " " +"#abadb0")  + ";margin:" + ("10px")  + ";padding:" + ("10px")  + ";font-weight:" + ("bold")  + ";}");
      }
  ...
  private void getProgressBarCssInitializer() {
    getProgressBarCss = new com.googlecode.mgwt.ui.client.theme.base.ProgressBarCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".mgwt-ProgressBar{position:" + ("relative")  + ";width:" + ("250px")  + ";height:" + ("15px")  + ";background-repeat:" + ("repeat-x")  + ";background-position-x:" + ("0")  + ";margin-right:" + ("auto")  + ";margin-left:" + ("auto")  + ";margin-top:" + ("20px")  + ";margin-bottom:" + ("20px")  + ";-moz-animation-duration:" + ("9s")  + ";-moz-animation-name:") + (("anmiateProgressBar")  + ";-moz-animation-iteration-count:" + ("infinite")  + ";-moz-animation-timing-function:" + ("linear")  + ";border:" + ("1px"+ " " +"solid"+ " " +"#bebebe")  + ";background-color:" + ("#3989d6")  + ";border-radius:" + ("6px")  + ";background-size:" + ("25px"+ " " +"15px")  + ";-moz-box-shadow:" + ("0"+ " " +"3px"+ " " +"3px"+ " " +"rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0.5" + ")")  + ";-moz-box-sizing:" + ("border-box")  + ";background-image:" + ("-moz-linear-gradient(top left ,  rgba(255, 255, 255, 0) 25%, rgba(255, 255, 255, 0.7) 30%, rgba(255, 255, 255, 1) 31%, rgba(255, 255, 255, 1) 70%, rgba(255, 255, 255, 0.7) 71%, rgba(255, 255, 255, 0) 80% ), -moz-linear-gradient(top, rgba(0, 0, 0, .2) 5%, rgba(255, 255, 255, .8) 6%, rgba(255, 255, 255, .05) 40%, rgba(0, 0, 0, .05) 60% , rgba(0, 0, 0, .2) 90% , rgba(0, 0, 0, .5) 98% ), -moz-linear-gradient(top, rgba(255,255,255, 1) 20%, rgba(255, 255, 255, .5) 21%, rgba(255, 255, 255, .5) 50% ,  rgba(255, 255, 255, 1) 51%)")  + ";}@-moz-keyframes anmiateProgressBar {\n	\n	    0% { background-position:   0 0; }\n	\n	    100% { background-position:   100% 0;}\n	\n	}")) : ((".mgwt-ProgressBar{position:" + ("relative")  + ";width:" + ("250px")  + ";height:" + ("15px")  + ";background-repeat:" + ("repeat-x")  + ";background-position-x:" + ("0")  + ";margin-left:" + ("auto")  + ";margin-right:" + ("auto")  + ";margin-top:" + ("20px")  + ";margin-bottom:" + ("20px")  + ";-moz-animation-duration:" + ("9s")  + ";-moz-animation-name:") + (("anmiateProgressBar")  + ";-moz-animation-iteration-count:" + ("infinite")  + ";-moz-animation-timing-function:" + ("linear")  + ";border:" + ("1px"+ " " +"solid"+ " " +"#bebebe")  + ";background-color:" + ("#3989d6")  + ";border-radius:" + ("6px")  + ";background-size:" + ("25px"+ " " +"15px")  + ";-moz-box-shadow:" + ("0"+ " " +"3px"+ " " +"3px"+ " " +"rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0.5" + ")")  + ";-moz-box-sizing:" + ("border-box")  + ";background-image:" + ("-moz-linear-gradient(top left ,  rgba(255, 255, 255, 0) 25%, rgba(255, 255, 255, 0.7) 30%, rgba(255, 255, 255, 1) 31%, rgba(255, 255, 255, 1) 70%, rgba(255, 255, 255, 0.7) 71%, rgba(255, 255, 255, 0) 80% ), -moz-linear-gradient(top, rgba(0, 0, 0, .2) 5%, rgba(255, 255, 255, .8) 6%, rgba(255, 255, 255, .05) 40%, rgba(0, 0, 0, .05) 60% , rgba(0, 0, 0, .2) 90% , rgba(0, 0, 0, .5) 98% ), -moz-linear-gradient(top, rgba(255,255,255, 1) 20%, rgba(255, 255, 255, .5) 21%, rgba(255, 255, 255, .5) 50% ,  rgba(255, 255, 255, 1) 51%)")  + ";}@-moz-keyframes anmiateProgressBar {\n	\n	    0% { background-position:   0 0; }\n	\n	    100% { background-position:   100% 0;}\n	\n	}"));
      }
  ...
  private void getPullToRefreshCssInitializer() {
    getPullToRefreshCss = new com.googlecode.mgwt.ui.client.theme.base.PullToRefreshCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".mgwt-PullToRefresh{position:" + ("relative")  + ";bottom:" + ("0")  + ";right:" + ("0")  + ";width:" + ("100%")  + ";height:" + ("70px")  + ";}.mgwt-PullToRefresh-arrow{height:" + ((MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getHeight() + "px")  + ";width:" + ((MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getSafeUri().asString() + "\") -" + (MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getLeft() + "px -" + (MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";margin-right:") + (("50px")  + ";top:" + ("20px")  + ";width:" + ("40px")  + ";height:" + ("40px")  + ";background-repeat:" + ("no-repeat")  + ";-moz-transform-origin:" + ("12px"+ " " +"9px")  + ";}.mgwt-PullToRefresh-spinner{position:" + ("absolute")  + ";margin-right:" + ("50px")  + ";top:" + ("10px")  + ";width:" + ("50px")  + ";height:" + ("50px") ) + (";}.mgwt-PullToRefresh-error{position:" + ("absolute")  + ";margin-right:" + ("50px")  + ";top:" + ("15px")  + ";width:" + ("50px")  + ";height:" + ("50px")  + ";background-image:" + ("url('" + ((com.google.gwt.resources.client.DataResource)(MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator.this.errorImage())).getUrl() + "')")  + ";background-repeat:" + ("no-repeat")  + ";}.mgwt-PullToRefresh-text{position:" + ("absolute")  + ";top:" + ("20px")  + ";right:" + ("110px")  + ";display:") + (("inline-block")  + ";font-size:" + ("20px")  + ";}")) : ((".mgwt-PullToRefresh{position:" + ("relative")  + ";bottom:" + ("0")  + ";left:" + ("0")  + ";width:" + ("100%")  + ";height:" + ("70px")  + ";}.mgwt-PullToRefresh-arrow{height:" + ((MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getHeight() + "px")  + ";width:" + ((MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getSafeUri().asString() + "\") -" + (MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getLeft() + "px -" + (MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";margin-left:") + (("50px")  + ";top:" + ("20px")  + ";width:" + ("40px")  + ";height:" + ("40px")  + ";background-repeat:" + ("no-repeat")  + ";-moz-transform-origin:" + ("12px"+ " " +"9px")  + ";}.mgwt-PullToRefresh-spinner{position:" + ("absolute")  + ";margin-left:" + ("50px")  + ";top:" + ("10px")  + ";width:" + ("50px")  + ";height:" + ("50px") ) + (";}.mgwt-PullToRefresh-error{position:" + ("absolute")  + ";margin-left:" + ("50px")  + ";top:" + ("15px")  + ";width:" + ("50px")  + ";height:" + ("50px")  + ";background-image:" + ("url('" + ((com.google.gwt.resources.client.DataResource)(MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator.this.errorImage())).getUrl() + "')")  + ";background-repeat:" + ("no-repeat")  + ";}.mgwt-PullToRefresh-text{position:" + ("absolute")  + ";top:" + ("20px")  + ";left:" + ("110px")  + ";display:") + (("inline-block")  + ";font-size:" + ("20px")  + ";}"));
      }
      public java.lang.String arrow(){
  ...
  private void getScrollPanelCssInitializer() {
    getScrollPanelCss = new com.googlecode.mgwt.ui.client.theme.base.ScrollPanelCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".mgwt-ScrollPanel{overflow:" + ("hidden")  + ";position:" + ("relative")  + ";z-index:" + ("0")  + ";display:" + ("-moz-box")  + ";-moz-box-orient:" + ("vertical")  + ";}.mgwt-ScrollPanel-container{overflow:" + ("visible")  + ";-moz-transition-property:" + ("-moz-transform")  + ";-moz-transition-timing-function:" + ("cubic-bezier(0, 0, 0.25, 1)")  + ";vertical-align:" + ("top")  + ";}.mgwt-Scrollbar{position:" + ("absolute")  + ";z-index:") + (("100")  + ";pointer-events:" + ("none")  + ";overflow:" + ("hidden")  + ";-moz-transition-duration:" + ("300ms")  + ";-moz-transition-delay:" + ("0")  + ";-moz-transition-property:" + ("opacity")  + ";}.mgwt-Scrollbar-horizontal{bottom:" + ("2px")  + ";right:" + ("2px")  + ";height:" + ("5px")  + ";}.mgwt-Scrollbar-vertical{top:" + ("2px")  + ";left:" + ("2px") ) + (";width:" + ("5px")  + ";}.mgwt-Scrollbar-Bar{position:" + ("absolute")  + ";z-index:" + ("100")  + ";background:" + ("rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0.5" + ")")  + ";border-radius:" + ("3px")  + ";pointer-events:" + ("none")  + ";-moz-background-clip:" + ("padding-box")  + ";-moz-box-sizing:" + ("border-box")  + ";-moz-transition-property:" + ("-webkit-transform")  + ";-moz-transition-timing-function:" + ("cubic-bezier(" + "0.33"+ ","+ " " +"0.66"+ ","+ " " +"0.66"+ ","+ " " +"1" + ")")  + ";-moz-transform:") + (("translate(" + "\"0,0\"" + ")")  + ";-moz-transition-duration:" + ("0")  + ";}")) : ((".mgwt-ScrollPanel{overflow:" + ("hidden")  + ";position:" + ("relative")  + ";z-index:" + ("0")  + ";display:" + ("-moz-box")  + ";-moz-box-orient:" + ("vertical")  + ";}.mgwt-ScrollPanel-container{overflow:" + ("visible")  + ";-moz-transition-property:" + ("-moz-transform")  + ";-moz-transition-timing-function:" + ("cubic-bezier(0, 0, 0.25, 1)")  + ";vertical-align:" + ("top")  + ";}.mgwt-Scrollbar{position:" + ("absolute")  + ";z-index:") + (("100")  + ";pointer-events:" + ("none")  + ";overflow:" + ("hidden")  + ";-moz-transition-duration:" + ("300ms")  + ";-moz-transition-delay:" + ("0")  + ";-moz-transition-property:" + ("opacity")  + ";}.mgwt-Scrollbar-horizontal{bottom:" + ("2px")  + ";left:" + ("2px")  + ";height:" + ("5px")  + ";}.mgwt-Scrollbar-vertical{top:" + ("2px")  + ";right:" + ("2px") ) + (";width:" + ("5px")  + ";}.mgwt-Scrollbar-Bar{position:" + ("absolute")  + ";z-index:" + ("100")  + ";background:" + ("rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0.5" + ")")  + ";border-radius:" + ("3px")  + ";pointer-events:" + ("none")  + ";-moz-background-clip:" + ("padding-box")  + ";-moz-box-sizing:" + ("border-box")  + ";-moz-transition-property:" + ("-webkit-transform")  + ";-moz-transition-timing-function:" + ("cubic-bezier(" + "0.33"+ ","+ " " +"0.66"+ ","+ " " +"0.66"+ ","+ " " +"1" + ")")  + ";-moz-transform:") + (("translate(" + "\"0,0\"" + ")")  + ";-moz-transition-duration:" + ("0")  + ";}"));
      }
      public java.lang.String container(){
  ...
  private void getSearchBoxCssInitializer() {
    getSearchBoxCss = new com.googlecode.mgwt.ui.client.theme.base.MSearchBoxCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".mgwt-SearchBox{height:" + ("44px")  + ";padding-right:" + ("5px")  + ";padding-left:" + ("5px")  + ";position:" + ("relative")  + ";}.mgwt-SearchBox-round{background-clip:" + ("padding-box")  + ";background-image:" + ("url('" + ((com.google.gwt.resources.client.DataResource)(MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator.this.searchSearchImage())).getUrl() + "')")  + ";background-repeat:" + ("no-repeat")  + ";background-position:" + ("10px"+ " " +"50%")  + ";width:" + ("100%")  + ";height:" + ("24px")  + ";display:") + (("block")  + ";position:" + ("relative")  + ";top:" + ("10px")  + ";margin:" + ("0")  + ";padding:" + ("0")  + ";}.mgwt-SearchBox-input{border:" + ("0")  + ";font-size:" + ("13px")  + ";padding:" + ("0")  + ";position:" + ("absolute")  + ";display:" + ("block")  + ";top:" + ("0") ) + (";right:" + ("25px")  + ";left:" + ("60px")  + ";bottom:" + ("0")  + ";top:" + ("5px")  + ";-moz-appearance:" + ("none")  + ";-moz-user-select:" + ("text")  + ";-moz-tap-highlight-color:" + ("rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0" + ")")  + ";}.mgwt-SearchBox-clear{position:" + ("absolute")  + ";top:" + ("-9px")  + ";left:" + ("10px")  + ";width:") + (("40px")  + ";height:" + ("40px")  + ";font-size:" + ("13px")  + ";padding:" + ("0")  + ";background-image:" + ("url('" + ((com.google.gwt.resources.client.DataResource)(MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator.this.searchClearImage())).getUrl() + "')")  + ";background-repeat:" + ("no-repeat")  + ";background-position:" + ("50%"+ " " +"50%")  + ";}.mgwt-SearchBox-clear-active{background-image:" + ("url('" + ((com.google.gwt.resources.client.DataResource)(MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator.this.searchClearTouchedImage())).getUrl() + "')")  + ";}.mgwt-SearchBox{background-size:" + ("100%"+ " " +"44px")  + ";background-repeat:" + ("repeat")  + ";background-position:" + ("0"+ " " +"0") ) + (";background-image:" + ("-moz-linear-gradient(top, #f1f3f4, #e0e4e7 3%, #c7cfd4 50%, #bec7cd 51%, #b4bec6 97%, #8999a5)")  + ";}.mgwt-SearchBox-round{border-bottom-right-radius:" + ("16px"+ " " +"16px")  + ";border-bottom-left-radius:" + ("16px"+ " " +"16px")  + ";border-top-right-radius:" + ("16px"+ " " +"16px")  + ";border-top-left-radius:" + ("16px"+ " " +"16px")  + ";background-color:" + ("white")  + ";}")) : ((".mgwt-SearchBox{height:" + ("44px")  + ";padding-left:" + ("5px")  + ";padding-right:" + ("5px")  + ";position:" + ("relative")  + ";}.mgwt-SearchBox-round{background-clip:" + ("padding-box")  + ";background-image:" + ("url('" + ((com.google.gwt.resources.client.DataResource)(MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator.this.searchSearchImage())).getUrl() + "')")  + ";background-repeat:" + ("no-repeat")  + ";background-position:" + ("10px"+ " " +"50%")  + ";width:" + ("100%")  + ";height:" + ("24px")  + ";display:") + (("block")  + ";position:" + ("relative")  + ";top:" + ("10px")  + ";margin:" + ("0")  + ";padding:" + ("0")  + ";}.mgwt-SearchBox-input{border:" + ("0")  + ";font-size:" + ("13px")  + ";padding:" + ("0")  + ";position:" + ("absolute")  + ";display:" + ("block")  + ";top:" + ("0") ) + (";left:" + ("25px")  + ";right:" + ("60px")  + ";bottom:" + ("0")  + ";top:" + ("5px")  + ";-moz-appearance:" + ("none")  + ";-moz-user-select:" + ("text")  + ";-moz-tap-highlight-color:" + ("rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0" + ")")  + ";}.mgwt-SearchBox-clear{position:" + ("absolute")  + ";top:" + ("-9px")  + ";right:" + ("10px")  + ";width:") + (("40px")  + ";height:" + ("40px")  + ";font-size:" + ("13px")  + ";padding:" + ("0")  + ";background-image:" + ("url('" + ((com.google.gwt.resources.client.DataResource)(MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator.this.searchClearImage())).getUrl() + "')")  + ";background-repeat:" + ("no-repeat")  + ";background-position:" + ("50%"+ " " +"50%")  + ";}.mgwt-SearchBox-clear-active{background-image:" + ("url('" + ((com.google.gwt.resources.client.DataResource)(MGWTClientBundleBaseThemeIPhone_iphone_gecko1_8_default_InlineClientBundleGenerator.this.searchClearTouchedImage())).getUrl() + "')")  + ";}.mgwt-SearchBox{background-size:" + ("100%"+ " " +"44px")  + ";background-repeat:" + ("repeat")  + ";background-position:" + ("0"+ " " +"0") ) + (";background-image:" + ("-moz-linear-gradient(top, #f1f3f4, #e0e4e7 3%, #c7cfd4 50%, #bec7cd 51%, #b4bec6 97%, #8999a5)")  + ";}.mgwt-SearchBox-round{border-bottom-left-radius:" + ("16px"+ " " +"16px")  + ";border-bottom-right-radius:" + ("16px"+ " " +"16px")  + ";border-top-left-radius:" + ("16px"+ " " +"16px")  + ";border-top-right-radius:" + ("16px"+ " " +"16px")  + ";background-color:" + ("white")  + ";}"));
      }
  ...
  private void getSliderCssInitializer() {
    getSliderCss = new com.googlecode.mgwt.ui.client.theme.base.SliderCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".mgwt-Slider{display:" + ("inline-block")  + ";width:" + ("277px")  + ";padding-top:" + ("10px")  + ";padding-bottom:" + ("10px")  + ";}.mgwt-Slider-bar{position:" + ("relative")  + ";height:" + ("9px")  + ";background-repeat:" + ("no-repeat"+ ","+ " " +"repeat-x")  + ";-moz-box-sizing:" + ("padding-box")  + ";-moz-box-shadow:" + ("2px"+ " " +"2px"+ " " +"4px"+ " " +"#666")  + ";-moz-border-radius:" + ("4px")  + ";border-radius:") + (("4px")  + ";border-radius:" + ("4px")  + ";background-image:" + ("-moz-linear-gradient(top, #0a3b87 , #4c8de7 50%, #6babf5 95%, #0a3b87 96%), -moz-linear-gradient(top, #929292, #f0f0f0 50%, #fff 51%, #fff 95%, #929292 100%)")  + ";}.mgwt-Slider-pointer{position:" + ("relative")  + ";height:" + ("20px")  + ";width:" + ("20px")  + ";right:" + ("-10px")  + ";top:" + ("-6px")  + ";border-radius:" + ("10px")  + ";-moz-tap-highlight-color:" + ("transparent")  + ";-moz-box-shadow:" + ("2px"+ " " +"2px"+ " " +"3px"+ " " +"#666") ) + (";-moz-border-radius:" + ("10px")  + ";background-image:" + ("-moz-linear-gradient(top, #aaaaaa,  #eeeeee 50%, #cccccc)")  + ";}")) : ((".mgwt-Slider{display:" + ("inline-block")  + ";width:" + ("277px")  + ";padding-top:" + ("10px")  + ";padding-bottom:" + ("10px")  + ";}.mgwt-Slider-bar{position:" + ("relative")  + ";height:" + ("9px")  + ";background-repeat:" + ("no-repeat"+ ","+ " " +"repeat-x")  + ";-moz-box-sizing:" + ("padding-box")  + ";-moz-box-shadow:" + ("2px"+ " " +"2px"+ " " +"4px"+ " " +"#666")  + ";-moz-border-radius:" + ("4px")  + ";border-radius:") + (("4px")  + ";border-radius:" + ("4px")  + ";background-image:" + ("-moz-linear-gradient(top, #0a3b87 , #4c8de7 50%, #6babf5 95%, #0a3b87 96%), -moz-linear-gradient(top, #929292, #f0f0f0 50%, #fff 51%, #fff 95%, #929292 100%)")  + ";}.mgwt-Slider-pointer{position:" + ("relative")  + ";height:" + ("20px")  + ";width:" + ("20px")  + ";left:" + ("-10px")  + ";top:" + ("-6px")  + ";border-radius:" + ("10px")  + ";-moz-tap-highlight-color:" + ("transparent")  + ";-moz-box-shadow:" + ("2px"+ " " +"2px"+ " " +"3px"+ " " +"#666") ) + (";-moz-border-radius:" + ("10px")  + ";background-image:" + ("-moz-linear-gradient(top, #aaaaaa,  #eeeeee 50%, #cccccc)")  + ";}"));
      }
  ...
  private void getTabBarCssInitializer() {
    getTabBarCss = new com.googlecode.mgwt.ui.client.theme.base.TabBarCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".mgwt-TabPanel{display:" + ("-webkit-box")  + ";-webkit-box-flex:" + ("1")  + ";-webkit-box-orient:" + ("vertical")  + ";width:" + ("100%")  + ";height:" + ("100%")  + ";}.GOE-WOTBKQ{display:" + ("-webkit-box")  + ";-webkit-box-flex:" + ("1")  + ";-webkit-box-orient:" + ("vertical")  + ";overflow:" + ("hidden")  + ";}.mgwt-TabBar{display:" + ("-webkit-box")  + ";-webkit-box-orient:") + (("horizontal")  + ";display:" + ("-moz-box")  + ";-moz-box-orient:" + ("horizontal")  + ";height:" + ("48px")  + ";border-top:" + ("1px"+ " " +"solid"+ " " +"black")  + ";background-image:" + ("-moz-linear-gradient(top, rgb(46, 46, 46), rgb(22, 22, 22) 50%, rgb(0,0,0) 51%, rgb(0,0,0))")  + ";}.mgwt-TabBar-Button{min-width:" + ("60px")  + ";background-color:" + ("transparent")  + ";box-sizing:" + ("content-box")  + ";-moz-appearance:" + ("none")  + ";-moz-box-flex:" + ("1") ) + (";margin:" + ("2px")  + ";-moz-border-radius:" + ("3px")  + ";border-radius:" + ("3px")  + ";}.mgwt-TabBar-Button-selected{background-color:" + ("rgba(" + "255"+ ","+ " " +"255"+ ","+ " " +"255"+ ","+ " " +"0.15" + ")")  + ";}.mgwt-TabBar-Button-selected .mgwt-TabBar-Button-text{color:" + ("white")  + ";}.mgwt-TabBar-Button-text{font-size:" + ("9px")  + ";color:" + ("#999995")  + ";text-align:" + ("center")  + ";z-index:" + ("1")  + ";margin-top:" + ("-5px")  + ";}.mgwt-TabBar-Button-icon{margin-right:") + (("auto")  + ";margin-left:" + ("auto")  + ";z-index:" + ("0")  + ";}")) : ((".mgwt-TabPanel{display:" + ("-webkit-box")  + ";-webkit-box-flex:" + ("1")  + ";-webkit-box-orient:" + ("vertical")  + ";width:" + ("100%")  + ";height:" + ("100%")  + ";}.GOE-WOTBKQ{display:" + ("-webkit-box")  + ";-webkit-box-flex:" + ("1")  + ";-webkit-box-orient:" + ("vertical")  + ";overflow:" + ("hidden")  + ";}.mgwt-TabBar{display:" + ("-webkit-box")  + ";-webkit-box-orient:") + (("horizontal")  + ";display:" + ("-moz-box")  + ";-moz-box-orient:" + ("horizontal")  + ";height:" + ("48px")  + ";border-top:" + ("1px"+ " " +"solid"+ " " +"black")  + ";background-image:" + ("-moz-linear-gradient(top, rgb(46, 46, 46), rgb(22, 22, 22) 50%, rgb(0,0,0) 51%, rgb(0,0,0))")  + ";}.mgwt-TabBar-Button{min-width:" + ("60px")  + ";background-color:" + ("transparent")  + ";box-sizing:" + ("content-box")  + ";-moz-appearance:" + ("none")  + ";-moz-box-flex:" + ("1") ) + (";margin:" + ("2px")  + ";-moz-border-radius:" + ("3px")  + ";border-radius:" + ("3px")  + ";}.mgwt-TabBar-Button-selected{background-color:" + ("rgba(" + "255"+ ","+ " " +"255"+ ","+ " " +"255"+ ","+ " " +"0.15" + ")")  + ";}.mgwt-TabBar-Button-selected .mgwt-TabBar-Button-text{color:" + ("white")  + ";}.mgwt-TabBar-Button-text{font-size:" + ("9px")  + ";color:" + ("#999995")  + ";text-align:" + ("center")  + ";z-index:" + ("1")  + ";margin-top:" + ("-5px")  + ";}.mgwt-TabBar-Button-icon{margin-left:") + (("auto")  + ";margin-right:" + ("auto")  + ";z-index:" + ("0")  + ";}"));
      }
      public java.lang.String active(){
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      case 'android_check_checked': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::android_check_checked()();
      case 'android_check_not_checked': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::android_check_not_checked()();
      case 'errorImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::errorImage()();
      case 'inputCheckImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::inputCheckImage()();
      case 'listArrow': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::listArrow()();
      case 'searchClearImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::searchClearImage()();
      case 'searchClearTouchedImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::searchClearTouchedImage()();
      case 'searchSearchImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::searchSearchImage()();
      case 'spinnerImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::spinnerImage()();
      case 'spinnerWhiteImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::spinnerWhiteImage()();
      case 'getButtonBarActionImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarActionImage()();
      case 'getButtonBarArrowDownImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarArrowDownImage()();
      case 'getButtonBarArrowLeftImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarArrowLeftImage()();
      case 'getButtonBarArrowRightImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarArrowRightImage()();
      case 'getButtonBarArrowUpImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarArrowUpImage()();
      case 'getButtonBarBookmarkImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarBookmarkImage()();
      case 'getButtonBarCameraImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarCameraImage()();
      case 'getButtonBarComposeImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarComposeImage()();
      case 'getButtonBarFastForwardImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarFastForwardImage()();
      case 'getButtonBarHighlightImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarHighlightImage()();
      case 'getButtonBarInfoImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarInfoImage()();
      case 'getButtonBarLocateImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarLocateImage()();
      case 'getButtonBarMinusImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarMinusImage()();
      case 'getButtonBarNewImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarNewImage()();
      case 'getButtonBarNextSlideImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarNextSlideImage()();
      case 'getButtonBarOrganizeImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarOrganizeImage()();
      case 'getButtonBarPauseImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarPauseImage()();
      case 'getButtonBarPlayImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarPlayImage()();
      case 'getButtonBarPlusImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarPlusImage()();
      case 'getButtonBarPreviousSlideImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarPreviousSlideImage()();
      case 'getButtonBarRefreshImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarRefreshImage()();
      case 'getButtonBarReplyImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarReplyImage()();
      case 'getButtonBarRewindImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarRewindImage()();
      case 'getButtonBarSearchImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarSearchImage()();
      case 'getButtonBarStopImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarStopImage()();
      case 'getButtonBarTrashImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarTrashImage()();
      case 'tabBarBookMarkImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::tabBarBookMarkImage()();
      case 'tabBarContactsImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::tabBarContactsImage()();
      case 'tabBarDownloadsImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::tabBarDownloadsImage()();
      case 'tabBarFavoritesImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::tabBarFavoritesImage()();
      case 'tabBarFeaturedImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::tabBarFeaturedImage()();
      case 'tabBarHistoryImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::tabBarHistoryImage()();
      case 'tabBarMoreImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::tabBarMoreImage()();
      case 'tabBarMostRecentImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::tabBarMostRecentImage()();
      case 'tabBarMostViewedImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::tabBarMostViewedImage()();
      case 'tabBarSearchImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::tabBarSearchImage()();
      case 'getButtonBarButtonCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarButtonCss()();
      case 'getButtonBarCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonBarCss()();
      case 'getButtonCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getButtonCss()();
      case 'getCarouselCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getCarouselCss()();
      case 'getCheckBoxCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getCheckBoxCss()();
      case 'getDialogCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getDialogCss()();
      case 'getGroupingList': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getGroupingList()();
      case 'getHeaderCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getHeaderCss()();
      case 'getInputCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getInputCss()();
      case 'getLayoutCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getLayoutCss()();
      case 'getListCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getListCss()();
      case 'getMainCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getMainCss()();
      case 'getPanelCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getPanelCss()();
      case 'getProgressBarCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getProgressBarCss()();
      case 'getProgressIndicatorCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getProgressIndicatorCss()();
      case 'getPullToRefreshCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getPullToRefreshCss()();
      case 'getScrollPanelCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getScrollPanelCss()();
      case 'getSearchBoxCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getSearchBoxCss()();
      case 'getSliderCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getSliderCss()();
      case 'getTabBarCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getTabBarCss()();
      case 'getUtilCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::getUtilCss()();
      case 'utilTextResource': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPhone::utilTextResource()();
    }
    return null;
  }-*/;
}
