...
public class MGWTClientBundleBaseThemeDesktop_iphone_safari_default_InlineClientBundleGenerator implements com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeDesktop {
  private static MGWTClientBundleBaseThemeDesktop_iphone_safari_default_InlineClientBundleGenerator _instance0 = new MGWTClientBundleBaseThemeDesktop_iphone_safari_default_InlineClientBundleGenerator();
  ...
  private void getPullToRefreshCssInitializer() {
    getPullToRefreshCss = new com.googlecode.mgwt.ui.client.theme.base.PullToRefreshCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".mgwt-PullToRefresh{position:" + ("relative")  + ";bottom:" + ("0")  + ";right:" + ("0")  + ";width:" + ("100%")  + ";height:" + ("70px")  + ";}.mgwt-PullToRefresh-arrow{height:" + ((MGWTClientBundleBaseThemeDesktop_iphone_safari_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getHeight() + "px")  + ";width:" + ((MGWTClientBundleBaseThemeDesktop_iphone_safari_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (MGWTClientBundleBaseThemeDesktop_iphone_safari_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getSafeUri().asString() + "\") -" + (MGWTClientBundleBaseThemeDesktop_iphone_safari_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getLeft() + "px -" + (MGWTClientBundleBaseThemeDesktop_iphone_safari_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";margin-right:") + (("50px")  + ";top:" + ("20px")  + ";width:" + ("40px")  + ";height:" + ("40px")  + ";background-repeat:" + ("no-repeat")  + ";-webkit-transform-origin:" + ("12px"+ " " +"9px")  + ";}.mgwt-PullToRefresh-spinner{position:" + ("absolute")  + ";margin-right:" + ("50px")  + ";top:" + ("10px")  + ";width:" + ("50px")  + ";height:" + ("50px") ) + (";}.mgwt-PullToRefresh-error{position:" + ("absolute")  + ";margin-right:" + ("50px")  + ";top:" + ("15px")  + ";width:" + ("50px")  + ";height:" + ("50px")  + ";background-image:" + ("url('" + ((com.google.gwt.resources.client.DataResource)(MGWTClientBundleBaseThemeDesktop_iphone_safari_default_InlineClientBundleGenerator.this.errorImage())).getUrl() + "')")  + ";background-repeat:" + ("no-repeat")  + ";}.mgwt-PullToRefresh-text{position:" + ("absolute")  + ";top:" + ("20px")  + ";right:" + ("110px")  + ";display:") + (("inline-block")  + ";font-size:" + ("20px")  + ";}")) : ((".mgwt-PullToRefresh{position:" + ("relative")  + ";bottom:" + ("0")  + ";left:" + ("0")  + ";width:" + ("100%")  + ";height:" + ("70px")  + ";}.mgwt-PullToRefresh-arrow{height:" + ((MGWTClientBundleBaseThemeDesktop_iphone_safari_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getHeight() + "px")  + ";width:" + ((MGWTClientBundleBaseThemeDesktop_iphone_safari_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (MGWTClientBundleBaseThemeDesktop_iphone_safari_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getSafeUri().asString() + "\") -" + (MGWTClientBundleBaseThemeDesktop_iphone_safari_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getLeft() + "px -" + (MGWTClientBundleBaseThemeDesktop_iphone_safari_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";margin-left:") + (("50px")  + ";top:" + ("20px")  + ";width:" + ("40px")  + ";height:" + ("40px")  + ";background-repeat:" + ("no-repeat")  + ";-webkit-transform-origin:" + ("12px"+ " " +"9px")  + ";}.mgwt-PullToRefresh-spinner{position:" + ("absolute")  + ";margin-left:" + ("50px")  + ";top:" + ("10px")  + ";width:" + ("50px")  + ";height:" + ("50px") ) + (";}.mgwt-PullToRefresh-error{position:" + ("absolute")  + ";margin-left:" + ("50px")  + ";top:" + ("15px")  + ";width:" + ("50px")  + ";height:" + ("50px")  + ";background-image:" + ("url('" + ((com.google.gwt.resources.client.DataResource)(MGWTClientBundleBaseThemeDesktop_iphone_safari_default_InlineClientBundleGenerator.this.errorImage())).getUrl() + "')")  + ";background-repeat:" + ("no-repeat")  + ";}.mgwt-PullToRefresh-text{position:" + ("absolute")  + ";top:" + ("20px")  + ";left:" + ("110px")  + ";display:") + (("inline-block")  + ";font-size:" + ("20px")  + ";}"));
      }
      public java.lang.String arrow(){
