...
public class StickFacade_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["it.mate.gwtcommons.client.utils.CollectionPropertyClientUtil/3491685941"] = [
        @it.mate.gwtcommons.client.utils.CollectionPropertyClientUtil_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @it.mate.gwtcommons.client.utils.CollectionPropertyClientUtil_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lit/mate/gwtcommons/client/utils/CollectionPropertyClientUtil;),
        @it.mate.gwtcommons.client.utils.CollectionPropertyClientUtil_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;Lit/mate/gwtcommons/client/utils/CollectionPropertyClientUtil;)
      ];
    
    result["it.mate.postscriptum.shared.model.RemoteUser/2437935365"] = [
        @it.mate.postscriptum.shared.model.RemoteUser_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @it.mate.postscriptum.shared.model.RemoteUser_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lit/mate/postscriptum/shared/model/RemoteUser;),
        @it.mate.postscriptum.shared.model.RemoteUser_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;Lit/mate/postscriptum/shared/model/RemoteUser;)
      ];
    
    result["[Lit.mate.postscriptum.shared.model.StickMail;/735334851"] = [
        @it.mate.postscriptum.shared.model.StickMail_Array_Rank_1_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @it.mate.postscriptum.shared.model.StickMail_Array_Rank_1_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;[Lit/mate/postscriptum/shared/model/StickMail;),
        @it.mate.postscriptum.shared.model.StickMail_Array_Rank_1_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;[Lit/mate/postscriptum/shared/model/StickMail;)
      ];
    
    result["it.mate.postscriptum.shared.model.impl.StickMailTx/518633928"] = [
        @it.mate.postscriptum.shared.model.impl.StickMailTx_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @it.mate.postscriptum.shared.model.impl.StickMailTx_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lit/mate/postscriptum/shared/model/impl/StickMailTx;),
        @it.mate.postscriptum.shared.model.impl.StickMailTx_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;Lit/mate/postscriptum/shared/model/impl/StickMailTx;)
      ];
    
    result["[Lit.mate.postscriptum.shared.model.impl.StickMailTx;/175794130"] = [
        @it.mate.postscriptum.shared.model.impl.StickMailTx_Array_Rank_1_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @it.mate.postscriptum.shared.model.impl.StickMailTx_Array_Rank_1_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;[Lit/mate/postscriptum/shared/model/impl/StickMailTx;),
        @it.mate.postscriptum.shared.model.impl.StickMailTx_Array_Rank_1_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;[Lit/mate/postscriptum/shared/model/impl/StickMailTx;)
      ];
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@it.mate.gwtcommons.client.utils.CollectionPropertyClientUtil::class)] = "it.mate.gwtcommons.client.utils.CollectionPropertyClientUtil/3491685941";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@it.mate.postscriptum.shared.model.RemoteUser::class)] = "it.mate.postscriptum.shared.model.RemoteUser/2437935365";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@it.mate.postscriptum.shared.model.StickMail[]::class)] = "[Lit.mate.postscriptum.shared.model.StickMail;/735334851";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@it.mate.postscriptum.shared.model.impl.StickMailTx::class)] = "it.mate.postscriptum.shared.model.impl.StickMailTx/518633928";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@it.mate.postscriptum.shared.model.impl.StickMailTx[]::class)] = "[Lit.mate.postscriptum.shared.model.impl.StickMailTx;/175794130";
  ...
  public StickFacade_TypeSerializer() {
