...
public class StickMailEPProxy extends AbstractEndpointProxy {
  ...
  private static final String API_ROOT =
      OsDetectionUtils.isDesktop() ? 
          ( LOCALTEST ? "http://127.0.0.1:8080/_ah/api" : "https://therapyremindersrv.appspot.com/_ah/api" ) :
          ( AppClientFactory.IMPL.getNativeProperty("endpointApiRoot", "https://therapyremindersrv.appspot.com/_ah/api") ) ;
