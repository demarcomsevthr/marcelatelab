...
public class LocalNotificationsPlugin {
  ...
  private static native void createEventImpl (String id, double date, String message, String title, JSOCallback success) /*-{
    ...
    var jsSuccess = $entry(function(message) {
      success.@it.mate.onscommons.client.plugins.LocalNotificationsPlugin.JSOCallback::handleEvent(Lcom/google/gwt/core/client/JavaScriptObject;)();
    });
  ...
  private static native void getScheduledIdsImpl (JSOCallback success) /*-{
    var jsSuccess = $entry(function(ids) {
      success.@it.mate.onscommons.client.plugins.LocalNotificationsPlugin.JSOCallback::handleEvent(Lcom/google/gwt/core/client/JavaScriptObject;)(ids);
    });
  ...
  private static native void setOnCancelImpl (JSOEventCallback callback) /*-{
    var jsCallback = $entry(function(id, state, json) {
      callback.@it.mate.onscommons.client.plugins.LocalNotificationsPlugin.JSOEventCallback::handleEvent(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)(id, state, json);
    });
