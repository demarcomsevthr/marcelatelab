...
public class MGWTClientBundleBaseThemeIPad_android_safari_it_InlineClientBundleGenerator implements com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad {
  private static MGWTClientBundleBaseThemeIPad_android_safari_it_InlineClientBundleGenerator _instance0 = new MGWTClientBundleBaseThemeIPad_android_safari_it_InlineClientBundleGenerator();
  private void android_check_checkedInitializer() {
    android_check_checked = // jar:file:/C:/Users/marcello/.m2/repository/com/googlecode/mgwt/mgwt/1.1.2/mgwt-1.1.2.jar!/com/googlecode/mgwt/ui/client/theme/base/resources/input/check_android_checked.png
  ...
  private void android_check_not_checkedInitializer() {
    android_check_not_checked = // jar:file:/C:/Users/marcello/.m2/repository/com/googlecode/mgwt/mgwt/1.1.2/mgwt-1.1.2.jar!/com/googlecode/mgwt/ui/client/theme/base/resources/input/check_android_not_checked.png
    new com.google.gwt.resources.client.impl.DataResourcePrototype(
  ...
  private void errorImageInitializer() {
    errorImage = // jar:file:/C:/Users/marcello/.m2/repository/com/googlecode/mgwt/mgwt/1.1.2/mgwt-1.1.2.jar!/com/googlecode/mgwt/ui/client/theme/base/resources/error.png
    new com.google.gwt.resources.client.impl.DataResourcePrototype(
      "errorImage",
  ...
  private void inputCheckImageInitializer() {
    inputCheckImage = // jar:file:/C:/Users/marcello/.m2/repository/com/googlecode/mgwt/mgwt/1.1.2/mgwt-1.1.2.jar!/com/googlecode/mgwt/ui/client/theme/base/resources/input/ios_check.png
    new com.google.gwt.resources.client.impl.DataResourcePrototype(
      "inputCheckImage",
  ...
  private void listArrowInitializer() {
    listArrow = // jar:file:/C:/Users/marcello/.m2/repository/com/googlecode/mgwt/mgwt/1.1.2/mgwt-1.1.2.jar!/com/googlecode/mgwt/ui/client/theme/base/resources/list/arrow.png
    new com.google.gwt.resources.client.impl.DataResourcePrototype(
      "listArrow",
  ...
  private void searchClearImageInitializer() {
    searchClearImage = // jar:file:/C:/Users/marcello/.m2/repository/com/googlecode/mgwt/mgwt/1.1.2/mgwt-1.1.2.jar!/com/googlecode/mgwt/ui/client/theme/base/resources/search/search_clear.png
    new com.google.gwt.resources.client.impl.DataResourcePrototype(
      "searchClearImage",
  ...
  private void searchClearTouchedImageInitializer() {
    searchClearTouchedImage = // jar:file:/C:/Users/marcello/.m2/repository/com/googlecode/mgwt/mgwt/1.1.2/mgwt-1.1.2.jar!/com/googlecode/mgwt/ui/client/theme/base/resources/search/search_clear_touched.png
    new com.google.gwt.resources.client.impl.DataResourcePrototype(
  ...
  private void searchSearchImageInitializer() {
    searchSearchImage = // jar:file:/C:/Users/marcello/.m2/repository/com/googlecode/mgwt/mgwt/1.1.2/mgwt-1.1.2.jar!/com/googlecode/mgwt/ui/client/theme/base/resources/search/glass.png
    new com.google.gwt.resources.client.impl.DataResourcePrototype(
      "searchSearchImage",
  ...
  private void spinnerImageInitializer() {
    spinnerImage = // jar:file:/C:/Users/marcello/.m2/repository/com/googlecode/mgwt/mgwt/1.1.2/mgwt-1.1.2.jar!/com/googlecode/mgwt/ui/client/theme/base/resources/spinner.png
    new com.google.gwt.resources.client.impl.DataResourcePrototype(
      "spinnerImage",
  ...
  private void spinnerWhiteImageInitializer() {
    spinnerWhiteImage = // jar:file:/C:/Users/marcello/.m2/repository/com/googlecode/mgwt/mgwt/1.1.2/mgwt-1.1.2.jar!/com/googlecode/mgwt/ui/client/theme/base/resources/spinner_white.png
    new com.google.gwt.resources.client.impl.DataResourcePrototype(
      "spinnerWhiteImage",
  ...
  private void getButtonBarCssInitializer() {
    getButtonBarCss = new com.googlecode.mgwt.ui.client.theme.base.ButtonBarCss() {
      ...
      public String getText() {
        return (".mgwt-ButtonBar{overflow:" + ("hidden")  + ";width:" + ("100%")  + ";position:" + ("relative")  + ";display:" + ("-webkit-box")  + ";-webkit-box-orient:" + ("horizontal")  + ";height:" + ("49px")  + ";border-top:" + ("1px"+ " " +"solid"+ " " +"#2d3642")  + ";background:" + ("-webkit-gradient(linear,left bottom,left top,color-stop(0, #A8ACB9),color-stop(1, #eee))")  + ";}.GEEN40JDCK{margin-top:" + ("14px")  + ";white-space:" + ("nowrap")  + ";overflow:") + (("hidden")  + ";text-overflow:" + ("ellipsis")  + ";text-align:" + ("center")  + ";font-size:" + ("12px")  + ";font-weight:" + ("bold")  + ";text-shadow:" + ("0"+ " " +"1px"+ " " +"0"+ " " +"#333")  + ";color:" + ("white")  + ";}.GEEN40JDBK{-webkit-box-flex:" + ("1")  + ";}");
      }
  ...
  private void getButtonCssInitializer() {
    getButtonCss = new com.googlecode.mgwt.ui.client.theme.base.ButtonCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".mgwt-Button{display:" + ("block")  + ";position:" + ("relative")  + ";padding:" + ("9px"+ " " +"13px")  + ";margin:" + ("5px")  + ";white-space:" + ("nowrap")  + ";overflow:" + ("hidden")  + ";text-overflow:" + ("ellipsis")  + ";font-size:" + ("19px")  + ";text-align:" + ("center")  + ";-webkit-appearance:" + ("none")  + ";}.mgwt-Button-small{padding:") + (("5px"+ " " +"7px")  + ";margin:" + ("2px")  + ";margin-right:" + ("5px")  + ";margin-left:" + ("5px")  + ";font-size:" + ("12px")  + ";}.mgwt-Button-round{border-bottom-right-radius:" + ("16px"+ " " +"16px")  + ";border-bottom-left-radius:" + ("16px"+ " " +"16px")  + ";border-top-right-radius:" + ("16px"+ " " +"16px")  + ";border-top-left-radius:" + ("16px"+ " " +"16px")  + ";}.mgwt-Button{border:" + ("solid"+ " " +"1px"+ " " +"rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0.5" + ")")  + ";color:" + ("#000") ) + (";font-weight:" + ("bold")  + ";box-sizing:" + ("content-box")  + ";-webkit-border-radius:" + ("6px")  + ";background-image:" + ("-webkit-gradient(linear,left bottom,left top,color-stop(0, #A8ACB9),color-stop(1, #eee))")  + ";}.mgwt-Button-active{color:" + ("#fff")  + ";background-image:" + ("-webkit-gradient(linear, left top, left bottom, from(rgb(5, 140, 245)),  to(rgb(1, 95, 230)) )")  + ";}.mgwt-Button-important{color:" + ("#fff")  + ";background-image:" + ("-webkit-gradient(linear, left top, left bottom, from(rgba(255,59,59,0.70)), color-stop(0.5, rgba(233,72,72,0.80)), color-stop(0.5, rgba(184,0,0,0.70)), to(rgba(255,0,0,0.80)))")  + ";}.mgwt-Button-important.mgwt-Button-active{background-image:" + ("-webkit-gradient(linear, left top, left bottom, from(rgba(255,30,30,1)), color-stop(0.5, rgba(233,40,40,1)), color-stop(0.5, rgba(184,0,0,1)), to(rgba(255,0,0,1)))")  + ";}.mgwt-Button-confirm{color:" + ("#fff")  + ";background-image:") + (("-webkit-gradient(linear, left top, left bottom, from(rgba(115,239,115,0.70)), color-stop(0.5, rgba(73,171,14,0.60)), color-stop(0.5, rgba(0,113,0,0.70)), to(rgba(0,150,0,0.80)))")  + ";}.mgwt-Button-confirm.mgwt-Button-active{background-image:" + ("-webkit-gradient(linear, left top, left bottom, from(rgba(80,200,80,1)), color-stop(0.5, rgba(50,150,0,1)), color-stop(0.5, rgba(0,100,0,1)), to(rgba(0,80,0,1)))")  + ";}.mgwt-Button-round{border-bottom-right-radius:" + ("16px"+ " " +"16px")  + ";border-bottom-left-radius:" + ("16px"+ " " +"16px")  + ";border-top-right-radius:" + ("16px"+ " " +"16px")  + ";border-top-left-radius:" + ("16px"+ " " +"16px")  + ";}")) : ((".mgwt-Button{display:" + ("block")  + ";position:" + ("relative")  + ";padding:" + ("9px"+ " " +"13px")  + ";margin:" + ("5px")  + ";white-space:" + ("nowrap")  + ";overflow:" + ("hidden")  + ";text-overflow:" + ("ellipsis")  + ";font-size:" + ("19px")  + ";text-align:" + ("center")  + ";-webkit-appearance:" + ("none")  + ";}.mgwt-Button-small{padding:") + (("5px"+ " " +"7px")  + ";margin:" + ("2px")  + ";margin-left:" + ("5px")  + ";margin-right:" + ("5px")  + ";font-size:" + ("12px")  + ";}.mgwt-Button-round{border-bottom-left-radius:" + ("16px"+ " " +"16px")  + ";border-bottom-right-radius:" + ("16px"+ " " +"16px")  + ";border-top-left-radius:" + ("16px"+ " " +"16px")  + ";border-top-right-radius:" + ("16px"+ " " +"16px")  + ";}.mgwt-Button{border:" + ("solid"+ " " +"1px"+ " " +"rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0.5" + ")")  + ";color:" + ("#000") ) + (";font-weight:" + ("bold")  + ";box-sizing:" + ("content-box")  + ";-webkit-border-radius:" + ("6px")  + ";background-image:" + ("-webkit-gradient(linear,left bottom,left top,color-stop(0, #A8ACB9),color-stop(1, #eee))")  + ";}.mgwt-Button-active{color:" + ("#fff")  + ";background-image:" + ("-webkit-gradient(linear, left top, left bottom, from(rgb(5, 140, 245)),  to(rgb(1, 95, 230)) )")  + ";}.mgwt-Button-important{color:" + ("#fff")  + ";background-image:" + ("-webkit-gradient(linear, left top, left bottom, from(rgba(255,59,59,0.70)), color-stop(0.5, rgba(233,72,72,0.80)), color-stop(0.5, rgba(184,0,0,0.70)), to(rgba(255,0,0,0.80)))")  + ";}.mgwt-Button-important.mgwt-Button-active{background-image:" + ("-webkit-gradient(linear, left top, left bottom, from(rgba(255,30,30,1)), color-stop(0.5, rgba(233,40,40,1)), color-stop(0.5, rgba(184,0,0,1)), to(rgba(255,0,0,1)))")  + ";}.mgwt-Button-confirm{color:" + ("#fff")  + ";background-image:") + (("-webkit-gradient(linear, left top, left bottom, from(rgba(115,239,115,0.70)), color-stop(0.5, rgba(73,171,14,0.60)), color-stop(0.5, rgba(0,113,0,0.70)), to(rgba(0,150,0,0.80)))")  + ";}.mgwt-Button-confirm.mgwt-Button-active{background-image:" + ("-webkit-gradient(linear, left top, left bottom, from(rgba(80,200,80,1)), color-stop(0.5, rgba(50,150,0,1)), color-stop(0.5, rgba(0,100,0,1)), to(rgba(0,80,0,1)))")  + ";}.mgwt-Button-round{border-bottom-left-radius:" + ("16px"+ " " +"16px")  + ";border-bottom-right-radius:" + ("16px"+ " " +"16px")  + ";border-top-left-radius:" + ("16px"+ " " +"16px")  + ";border-top-right-radius:" + ("16px"+ " " +"16px")  + ";}"));
      }
      public java.lang.String active(){
  ...
  private void getCarouselCssInitializer() {
    getCarouselCss = new com.googlecode.mgwt.ui.client.theme.base.CarouselCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".mgwt-Carousel{position:" + ("relative")  + ";display:" + ("-webkit-box")  + ";-webkit-box-flex:" + ("1")  + ";}.mgwt-Carousel-Scroller{-webkit-box-flex:" + ("1")  + ";}.mgwt-Carousel-Container{display:" + ("-webkit-box")  + ";-webkit-box-flex:" + ("1")  + ";}.mgwt-Carousel-Indicator-Container{position:" + ("absolute")  + ";left:" + ("0")  + ";right:" + ("0")  + ";bottom:" + ("0")  + ";display:") + (("-webkit-box")  + ";-webkit-box-pack:" + ("center")  + ";}.mgwt-Carousel-Indicator{width:" + ("8px")  + ";height:" + ("8px")  + ";background-color:" + ("#d3d3d3")  + ";border-radius:" + ("4px")  + ";margin:" + ("4px")  + ";}.mgwt-Carousel-Indicator-active{background-color:" + ("#757575")  + ";}.mgwt-Carousel-Holder{position:" + ("relative")  + ";display:" + ("-webkit-box")  + ";}")) : ((".mgwt-Carousel{position:" + ("relative")  + ";display:" + ("-webkit-box")  + ";-webkit-box-flex:" + ("1")  + ";}.mgwt-Carousel-Scroller{-webkit-box-flex:" + ("1")  + ";}.mgwt-Carousel-Container{display:" + ("-webkit-box")  + ";-webkit-box-flex:" + ("1")  + ";}.mgwt-Carousel-Indicator-Container{position:" + ("absolute")  + ";right:" + ("0")  + ";left:" + ("0")  + ";bottom:" + ("0")  + ";display:") + (("-webkit-box")  + ";-webkit-box-pack:" + ("center")  + ";}.mgwt-Carousel-Indicator{width:" + ("8px")  + ";height:" + ("8px")  + ";background-color:" + ("#d3d3d3")  + ";border-radius:" + ("4px")  + ";margin:" + ("4px")  + ";}.mgwt-Carousel-Indicator-active{background-color:" + ("#757575")  + ";}.mgwt-Carousel-Holder{position:" + ("relative")  + ";display:" + ("-webkit-box")  + ";}"));
      }
  ...
  private void getDialogCssInitializer() {
    getDialogCss = new com.googlecode.mgwt.ui.client.theme.base.DialogCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".z_index{z-index:" + ("100")  + ";}.mgwt-DialogAnimationContainer-Shadow{z-index:" + ("100")  + ";background-color:" + ("rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0.4" + ")")  + ";}.mgwt-DialogAnimationContainer{display:" + ("-webkit-box")  + ";width:" + ("100%")  + ";height:" + ("100%")  + ";overflow:" + ("hidden")  + ";}.mgwt-DialogAnimationContainer-center{-webkit-box-orient:" + ("horizontal")  + ";-webkit-box-pack:" + ("center")  + ";-webkit-box-align:" + ("center")  + ";}.mgwt-BottomPanel{position:") + (("absolute")  + ";bottom:" + ("0")  + ";right:" + ("0")  + ";left:" + ("0")  + ";background-color:" + ("rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0.9" + ")")  + ";background-image:" + ("-webkit-gradient(linear, 0% 0, 0% 100%, from(rgba(50, 74, 103, 0.9)), color-stop(0.02, rgba(20, 25, 35, 0.9) ), to(rgba(0, 0, 0, 0.0) ) )")  + ";border-top:" + ("1px"+ " " +"solid"+ " " +"#030506")  + ";padding:" + ("10px")  + ";}.mgwt-DialogPanel{border:" + ("solid"+ " " +"1px"+ " " +"#72767b")  + ";padding:" + ("0")  + ";opacity:" + ("1") ) + (";-webkit-border-radius:" + ("10px")  + ";-webkit-box-shadow:" + ("0"+ " " +"4px"+ " " +"6px"+ " " +"#666"+ ","+ " " +"0"+ " " +"0"+ " " +"50px"+ " " +"rgba(" + "255"+ ","+ " " +"255"+ ","+ " " +"255"+ ","+ " " +"1" + ")")  + ";background-image:" + ("-webkit-gradient(linear, left top, left bottom, from(rgba(0, 15, 70, 0.5) ), to(rgba(0, 0, 70, 0.5) ) )")  + ";}.mgwt-DialogPanel .container{color:" + ("#fff")  + ";text-shadow:" + ("0"+ " " +"-1px"+ " " +"1px"+ " " +"#000")  + ";border:" + ("solid"+ " " +"2px"+ " " +"#e6e6ee")  + ";padding:" + ("5px")  + ";-webkit-border-radius:" + ("10px")  + ";background-image:" + ("-webkit-gradient(radial, 50% -1180, 150, 50% -280, 1400, color-stop(0, rgba(140, 150, 170, 1) ), color-stop(0.48, rgba(140, 150, 170, 1) ), color-stop(0.499, rgba(75, 90, 120, .9) ), color-stop(0.5, rgba(75, 90, 120, 0) ) )")  + ";}.mgwt-DialogPanel .title{-webkit-border-top-left-radius:" + ("10px")  + ";-webkit-border-top-right-radius:") + (("10px")  + ";color:" + ("#fff")  + ";background:" + ("none")  + ";border:" + ("none")  + ";text-shadow:" + ("0"+ " " +"-2px"+ " " +"1px"+ " " +"#000")  + ";width:" + ("100%")  + ";text-align:" + ("center")  + ";font-size:" + ("19px")  + ";margin-bottom:" + ("20px")  + ";-webkit-border-top-left-radius:" + ("10px")  + ";-webkit-border-top-right-radius:" + ("10px") ) + (";}.mgwt-DialogPanel .content{margin:" + ("10px")  + ";}.mgwt-DialogPanel .footer{margin-top:" + ("10px")  + ";-webkit-box-pack:" + ("justify")  + ";display:" + ("-webkit-box")  + ";-webkit-box-orient:" + ("horizontal")  + ";-webkit-box-sizing:" + ("border-box")  + ";}.mgwt-DialogPanel .okbutton{display:" + ("block")  + ";font-size:" + ("17px")  + ";font-weight:" + ("bold")  + ";text-align:" + ("center")  + ";margin-top:") + (("10px")  + ";margin-left:" + ("5px")  + ";padding-left:" + ("5px")  + ";padding-right:" + ("5px")  + ";min-width:" + ("40px")  + ";height:" + ("32px")  + ";line-height:" + ("32px")  + ";text-shadow:" + ("0"+ " " +"-2px"+ " " +"1px"+ " " +"#000")  + ";-webkit-box-flex:" + ("2")  + ";-webkit-border-radius:" + ("8px")  + ";background-image:" + ("-webkit-gradient(linear, left top, left bottom, from(#b0b5c5),color-stop(0.5, #7a839b), color-stop(0.5, #515d7c), to(#636e8a) )") ) + (";}.mgwt-DialogPanel .cancelbutton{display:" + ("block")  + ";font-size:" + ("17px")  + ";font-weight:" + ("bold")  + ";text-align:" + ("center")  + ";margin-top:" + ("10px")  + ";margin-left:" + ("5px")  + ";padding-left:" + ("5px")  + ";padding-right:" + ("5px")  + ";min-width:" + ("40px")  + ";height:" + ("32px")  + ";line-height:") + (("32px")  + ";text-shadow:" + ("0"+ " " +"-2px"+ " " +"1px"+ " " +"#000")  + ";-webkit-box-flex:" + ("2")  + ";-webkit-border-radius:" + ("8px")  + ";background-image:" + ("-webkit-gradient(linear, left top, left bottom, from(#828ba3), color-stop(0.5, #4c5a7c), color-stop(0.5, #27375f), to(#2e3d64) )")  + ";}.mgwt-DialogPanel .cancelbutton.active,.mgwt-DialogPanel .okbutton.active{background-image:" + ("-webkit-gradient(linear, left top, left bottom, from(#70747f), color-stop(0.5, #424857), color-stop(0.5, #171e30), to(#222839) )")  + ";}")) : ((".z_index{z-index:" + ("100")  + ";}.mgwt-DialogAnimationContainer-Shadow{z-index:" + ("100")  + ";background-color:" + ("rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0.4" + ")")  + ";}.mgwt-DialogAnimationContainer{display:" + ("-webkit-box")  + ";width:" + ("100%")  + ";height:" + ("100%")  + ";overflow:" + ("hidden")  + ";}.mgwt-DialogAnimationContainer-center{-webkit-box-orient:" + ("horizontal")  + ";-webkit-box-pack:" + ("center")  + ";-webkit-box-align:" + ("center")  + ";}.mgwt-BottomPanel{position:") + (("absolute")  + ";bottom:" + ("0")  + ";left:" + ("0")  + ";right:" + ("0")  + ";background-color:" + ("rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0.9" + ")")  + ";background-image:" + ("-webkit-gradient(linear, 0% 0, 0% 100%, from(rgba(50, 74, 103, 0.9)), color-stop(0.02, rgba(20, 25, 35, 0.9) ), to(rgba(0, 0, 0, 0.0) ) )")  + ";border-top:" + ("1px"+ " " +"solid"+ " " +"#030506")  + ";padding:" + ("10px")  + ";}.mgwt-DialogPanel{border:" + ("solid"+ " " +"1px"+ " " +"#72767b")  + ";padding:" + ("0")  + ";opacity:" + ("1") ) + (";-webkit-border-radius:" + ("10px")  + ";-webkit-box-shadow:" + ("0"+ " " +"4px"+ " " +"6px"+ " " +"#666"+ ","+ " " +"0"+ " " +"0"+ " " +"50px"+ " " +"rgba(" + "255"+ ","+ " " +"255"+ ","+ " " +"255"+ ","+ " " +"1" + ")")  + ";background-image:" + ("-webkit-gradient(linear, left top, left bottom, from(rgba(0, 15, 70, 0.5) ), to(rgba(0, 0, 70, 0.5) ) )")  + ";}.mgwt-DialogPanel .container{color:" + ("#fff")  + ";text-shadow:" + ("0"+ " " +"-1px"+ " " +"1px"+ " " +"#000")  + ";border:" + ("solid"+ " " +"2px"+ " " +"#e6e6ee")  + ";padding:" + ("5px")  + ";-webkit-border-radius:" + ("10px")  + ";background-image:" + ("-webkit-gradient(radial, 50% -1180, 150, 50% -280, 1400, color-stop(0, rgba(140, 150, 170, 1) ), color-stop(0.48, rgba(140, 150, 170, 1) ), color-stop(0.499, rgba(75, 90, 120, .9) ), color-stop(0.5, rgba(75, 90, 120, 0) ) )")  + ";}.mgwt-DialogPanel .title{-webkit-border-top-right-radius:" + ("10px")  + ";-webkit-border-top-left-radius:") + (("10px")  + ";color:" + ("#fff")  + ";background:" + ("none")  + ";border:" + ("none")  + ";text-shadow:" + ("0"+ " " +"-2px"+ " " +"1px"+ " " +"#000")  + ";width:" + ("100%")  + ";text-align:" + ("center")  + ";font-size:" + ("19px")  + ";margin-bottom:" + ("20px")  + ";-webkit-border-top-right-radius:" + ("10px")  + ";-webkit-border-top-left-radius:" + ("10px") ) + (";}.mgwt-DialogPanel .content{margin:" + ("10px")  + ";}.mgwt-DialogPanel .footer{margin-top:" + ("10px")  + ";-webkit-box-pack:" + ("justify")  + ";display:" + ("-webkit-box")  + ";-webkit-box-orient:" + ("horizontal")  + ";-webkit-box-sizing:" + ("border-box")  + ";}.mgwt-DialogPanel .okbutton{display:" + ("block")  + ";font-size:" + ("17px")  + ";font-weight:" + ("bold")  + ";text-align:" + ("center")  + ";margin-top:") + (("10px")  + ";margin-right:" + ("5px")  + ";padding-right:" + ("5px")  + ";padding-left:" + ("5px")  + ";min-width:" + ("40px")  + ";height:" + ("32px")  + ";line-height:" + ("32px")  + ";text-shadow:" + ("0"+ " " +"-2px"+ " " +"1px"+ " " +"#000")  + ";-webkit-box-flex:" + ("2")  + ";-webkit-border-radius:" + ("8px")  + ";background-image:" + ("-webkit-gradient(linear, left top, left bottom, from(#b0b5c5),color-stop(0.5, #7a839b), color-stop(0.5, #515d7c), to(#636e8a) )") ) + (";}.mgwt-DialogPanel .cancelbutton{display:" + ("block")  + ";font-size:" + ("17px")  + ";font-weight:" + ("bold")  + ";text-align:" + ("center")  + ";margin-top:" + ("10px")  + ";margin-right:" + ("5px")  + ";padding-right:" + ("5px")  + ";padding-left:" + ("5px")  + ";min-width:" + ("40px")  + ";height:" + ("32px")  + ";line-height:") + (("32px")  + ";text-shadow:" + ("0"+ " " +"-2px"+ " " +"1px"+ " " +"#000")  + ";-webkit-box-flex:" + ("2")  + ";-webkit-border-radius:" + ("8px")  + ";background-image:" + ("-webkit-gradient(linear, left top, left bottom, from(#828ba3), color-stop(0.5, #4c5a7c), color-stop(0.5, #27375f), to(#2e3d64) )")  + ";}.mgwt-DialogPanel .cancelbutton.active,.mgwt-DialogPanel .okbutton.active{background-image:" + ("-webkit-gradient(linear, left top, left bottom, from(#70747f), color-stop(0.5, #424857), color-stop(0.5, #171e30), to(#222839) )")  + ";}"));
      }
      public java.lang.String active(){
        return "active";
      }
  ...
  private void getLayoutCssInitializer() {
    getLayoutCss = new com.googlecode.mgwt.ui.client.theme.base.LayoutCss() {
      ...
      public String getText() {
        return (".GEEN40JDAO{display:" + ("-webkit-box")  + ";-webkit-box-orient:" + ("vertical")  + ";width:" + ("100%")  + ";height:" + ("100%")  + ";}.GEEN40JDCO{-webkit-box-orient:" + ("horizontal")  + ";}.GEEN40JDBO{-webkit-box-flex:" + ("1")  + ";}");
      }
  ...
  private void getListCssInitializer() {
    getListCss = new com.googlecode.mgwt.ui.client.theme.base.ListCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".mgwt-List{position:" + ("relative")  + ";list-style:" + ("none")  + ";border-collapse:" + ("collapse")  + ";}.mgwt-List>li{position:" + ("relative")  + ";list-style-type:" + ("none")  + ";display:" + ("block")  + ";overflow:" + ("hidden")  + ";width:" + ("auto")  + ";padding:" + ("12px")  + ";background-color:" + ("white")  + ";border:") + (("1px"+ " " +"solid"+ " " +"#abadb0")  + ";border-bottom:" + ("none")  + ";}.mgwt-List-round{padding:" + ("10px")  + ";}.mgwt-FormList-Element{margin:" + ("-12px")  + ";display:" + ("-webkit-box")  + ";}.mgwt-FormList-Element-label{padding:" + ("10px")  + ";width:" + ("30%")  + ";overflow:" + ("hidden")  + ";text-overflow:" + ("ellipsis")  + ";background-color:" + ("#f3f3f3")  + ";}.mgwt-FormList-Element-container{padding:" + ("10px") ) + (";-webkit-box-flex:" + ("1")  + ";-webkit-box-pack:" + ("end")  + ";display:" + ("-webkit-box")  + ";}.mgwt-List-round>.mgwt-List-first{border-top-right-radius:" + ("8px"+ " " +"8px")  + ";border-top-left-radius:" + ("8px"+ " " +"8px")  + ";}.mgwt-List-round>.mgwt-List-last{border-bottom-right-radius:" + ("8px"+ " " +"8px")  + ";border-bottom-left-radius:" + ("8px"+ " " +"8px")  + ";border-bottom:" + ("1px"+ " " +"solid"+ " " +"#abadb0")  + ";}.mgwt-List-round>.mgwt-List-first>.mgwt-FormList-Element{border-top-right-radius:" + ("7px"+ " " +"7px")  + ";border-top-left-radius:" + ("7px"+ " " +"7px")  + ";overflow:") + (("hidden")  + ";}.mgwt-List-round>.mgwt-List-last>.mgwt-FormList-Element{border-bottom-right-radius:" + ("7px"+ " " +"7px")  + ";border-bottom-left-radius:" + ("7px"+ " " +"7px")  + ";overflow:" + ("hidden")  + ";}.mgwt-List-canbeSelected.mgwt-List-selected{font-weight:" + ("bold")  + ";color:" + ("white")  + ";background-repeat:" + ("no-repeat"+ ","+ " " +"repeat")  + ";background-position:" + ("0"+ " " +"50%"+ ","+ " " +"0"+ " " +"0")  + ";background-image:" + ("-webkit-gradient(linear, left top, left bottom, from(rgb(5, 140, 245)), to(rgb(1, 95, 230)) )")  + ";}.mgwt-List-group{background-image:" + ("url('" + ((com.google.gwt.resources.client.DataResource)(MGWTClientBundleBaseThemeIPad_android_safari_it_InlineClientBundleGenerator.this.listArrow())).getUrl() + "')")  + ";background-repeat:" + ("no-repeat") ) + (";background-position:" + ("0"+ " " +"50%")  + ";}.mgwt-List-group.mgwt-List-selected{font-weight:" + ("bold")  + ";color:" + ("white")  + ";background-repeat:" + ("no-repeat"+ ","+ " " +"repeat")  + ";background-position:" + ("0"+ " " +"50%"+ ","+ " " +"0"+ " " +"0")  + ";background-image:" + ("url('" + ((com.google.gwt.resources.client.DataResource)(MGWTClientBundleBaseThemeIPad_android_safari_it_InlineClientBundleGenerator.this.listArrow())).getUrl() + "')"+ ","+ " " +"-webkit-gradient(linear, left top, left bottom, from(rgb(5, 140, 245)), to(rgb(1, 95, 230)) )")  + ";}.mgwt-List-Header{color:" + ("black")  + ";font-size:" + ("18px")  + ";font-weight:" + ("bold")  + ";margin:" + ("10px"+ " " +"20px"+ " " +"5px")  + ";text-shadow:") + (("rgba(" + "255"+ ","+ " " +"255"+ ","+ " " +"255"+ ","+ " " +"0.19" + ")")  + ";}.mgwt-List-Head-Element,.mgwt-List>.mgwt-List-Head-Element{padding:" + ("0")  + ";padding-right:" + ("12px")  + ";font-size:" + ("19px")  + ";font-weight:" + ("bold")  + ";color:" + ("#fff")  + ";border-bottom:" + ("1px"+ " " +"solid"+ " " +"#989ea5")  + ";border:" + ("none")  + ";background:" + ("-webkit-gradient(linear,left bottom,left top,color-stop(0, #A8ACB9),color-stop(1, #eee))")  + ";}")) : ((".mgwt-List{position:" + ("relative")  + ";list-style:" + ("none")  + ";border-collapse:" + ("collapse")  + ";}.mgwt-List>li{position:" + ("relative")  + ";list-style-type:" + ("none")  + ";display:" + ("block")  + ";overflow:" + ("hidden")  + ";width:" + ("auto")  + ";padding:" + ("12px")  + ";background-color:" + ("white")  + ";border:") + (("1px"+ " " +"solid"+ " " +"#abadb0")  + ";border-bottom:" + ("none")  + ";}.mgwt-List-round{padding:" + ("10px")  + ";}.mgwt-FormList-Element{margin:" + ("-12px")  + ";display:" + ("-webkit-box")  + ";}.mgwt-FormList-Element-label{padding:" + ("10px")  + ";width:" + ("30%")  + ";overflow:" + ("hidden")  + ";text-overflow:" + ("ellipsis")  + ";background-color:" + ("#f3f3f3")  + ";}.mgwt-FormList-Element-container{padding:" + ("10px") ) + (";-webkit-box-flex:" + ("1")  + ";-webkit-box-pack:" + ("end")  + ";display:" + ("-webkit-box")  + ";}.mgwt-List-round>.mgwt-List-first{border-top-left-radius:" + ("8px"+ " " +"8px")  + ";border-top-right-radius:" + ("8px"+ " " +"8px")  + ";}.mgwt-List-round>.mgwt-List-last{border-bottom-left-radius:" + ("8px"+ " " +"8px")  + ";border-bottom-right-radius:" + ("8px"+ " " +"8px")  + ";border-bottom:" + ("1px"+ " " +"solid"+ " " +"#abadb0")  + ";}.mgwt-List-round>.mgwt-List-first>.mgwt-FormList-Element{border-top-left-radius:" + ("7px"+ " " +"7px")  + ";border-top-right-radius:" + ("7px"+ " " +"7px")  + ";overflow:") + (("hidden")  + ";}.mgwt-List-round>.mgwt-List-last>.mgwt-FormList-Element{border-bottom-left-radius:" + ("7px"+ " " +"7px")  + ";border-bottom-right-radius:" + ("7px"+ " " +"7px")  + ";overflow:" + ("hidden")  + ";}.mgwt-List-canbeSelected.mgwt-List-selected{font-weight:" + ("bold")  + ";color:" + ("white")  + ";background-repeat:" + ("no-repeat"+ ","+ " " +"repeat")  + ";background-position:" + ("100%"+ " " +"50%"+ ","+ " " +"0"+ " " +"0")  + ";background-image:" + ("-webkit-gradient(linear, left top, left bottom, from(rgb(5, 140, 245)), to(rgb(1, 95, 230)) )")  + ";}.mgwt-List-group{background-image:" + ("url('" + ((com.google.gwt.resources.client.DataResource)(MGWTClientBundleBaseThemeIPad_android_safari_it_InlineClientBundleGenerator.this.listArrow())).getUrl() + "')")  + ";background-repeat:" + ("no-repeat") ) + (";background-position:" + ("100%"+ " " +"50%")  + ";}.mgwt-List-group.mgwt-List-selected{font-weight:" + ("bold")  + ";color:" + ("white")  + ";background-repeat:" + ("no-repeat"+ ","+ " " +"repeat")  + ";background-position:" + ("100%"+ " " +"50%"+ ","+ " " +"0"+ " " +"0")  + ";background-image:" + ("url('" + ((com.google.gwt.resources.client.DataResource)(MGWTClientBundleBaseThemeIPad_android_safari_it_InlineClientBundleGenerator.this.listArrow())).getUrl() + "')"+ ","+ " " +"-webkit-gradient(linear, left top, left bottom, from(rgb(5, 140, 245)), to(rgb(1, 95, 230)) )")  + ";}.mgwt-List-Header{color:" + ("black")  + ";font-size:" + ("18px")  + ";font-weight:" + ("bold")  + ";margin:" + ("10px"+ " " +"20px"+ " " +"5px")  + ";text-shadow:") + (("rgba(" + "255"+ ","+ " " +"255"+ ","+ " " +"255"+ ","+ " " +"0.19" + ")")  + ";}.mgwt-List-Head-Element,.mgwt-List>.mgwt-List-Head-Element{padding:" + ("0")  + ";padding-left:" + ("12px")  + ";font-size:" + ("19px")  + ";font-weight:" + ("bold")  + ";color:" + ("#fff")  + ";border-bottom:" + ("1px"+ " " +"solid"+ " " +"#989ea5")  + ";border:" + ("none")  + ";background:" + ("-webkit-gradient(linear,left bottom,left top,color-stop(0, #A8ACB9),color-stop(1, #eee))")  + ";}"));
      }
  ...
  private void getPullToRefreshCssInitializer() {
    getPullToRefreshCss = new com.googlecode.mgwt.ui.client.theme.base.PullToRefreshCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".mgwt-PullToRefresh{position:" + ("relative")  + ";bottom:" + ("0")  + ";right:" + ("0")  + ";width:" + ("100%")  + ";height:" + ("70px")  + ";}.mgwt-PullToRefresh-arrow{height:" + ((MGWTClientBundleBaseThemeIPad_android_safari_it_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getHeight() + "px")  + ";width:" + ((MGWTClientBundleBaseThemeIPad_android_safari_it_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (MGWTClientBundleBaseThemeIPad_android_safari_it_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getSafeUri().asString() + "\") -" + (MGWTClientBundleBaseThemeIPad_android_safari_it_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getLeft() + "px -" + (MGWTClientBundleBaseThemeIPad_android_safari_it_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";margin-right:") + (("50px")  + ";top:" + ("20px")  + ";width:" + ("40px")  + ";height:" + ("40px")  + ";background-repeat:" + ("no-repeat")  + ";-webkit-transform-origin:" + ("12px"+ " " +"9px")  + ";}.mgwt-PullToRefresh-spinner{position:" + ("absolute")  + ";margin-right:" + ("50px")  + ";top:" + ("10px")  + ";width:" + ("50px")  + ";height:" + ("50px") ) + (";}.mgwt-PullToRefresh-error{position:" + ("absolute")  + ";margin-right:" + ("50px")  + ";top:" + ("15px")  + ";width:" + ("50px")  + ";height:" + ("50px")  + ";background-image:" + ("url('" + ((com.google.gwt.resources.client.DataResource)(MGWTClientBundleBaseThemeIPad_android_safari_it_InlineClientBundleGenerator.this.errorImage())).getUrl() + "')")  + ";background-repeat:" + ("no-repeat")  + ";}.mgwt-PullToRefresh-text{position:" + ("absolute")  + ";top:" + ("20px")  + ";right:" + ("110px")  + ";display:") + (("inline-block")  + ";font-size:" + ("20px")  + ";}")) : ((".mgwt-PullToRefresh{position:" + ("relative")  + ";bottom:" + ("0")  + ";left:" + ("0")  + ";width:" + ("100%")  + ";height:" + ("70px")  + ";}.mgwt-PullToRefresh-arrow{height:" + ((MGWTClientBundleBaseThemeIPad_android_safari_it_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getHeight() + "px")  + ";width:" + ((MGWTClientBundleBaseThemeIPad_android_safari_it_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (MGWTClientBundleBaseThemeIPad_android_safari_it_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getSafeUri().asString() + "\") -" + (MGWTClientBundleBaseThemeIPad_android_safari_it_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getLeft() + "px -" + (MGWTClientBundleBaseThemeIPad_android_safari_it_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";margin-left:") + (("50px")  + ";top:" + ("20px")  + ";width:" + ("40px")  + ";height:" + ("40px")  + ";background-repeat:" + ("no-repeat")  + ";-webkit-transform-origin:" + ("12px"+ " " +"9px")  + ";}.mgwt-PullToRefresh-spinner{position:" + ("absolute")  + ";margin-left:" + ("50px")  + ";top:" + ("10px")  + ";width:" + ("50px")  + ";height:" + ("50px") ) + (";}.mgwt-PullToRefresh-error{position:" + ("absolute")  + ";margin-left:" + ("50px")  + ";top:" + ("15px")  + ";width:" + ("50px")  + ";height:" + ("50px")  + ";background-image:" + ("url('" + ((com.google.gwt.resources.client.DataResource)(MGWTClientBundleBaseThemeIPad_android_safari_it_InlineClientBundleGenerator.this.errorImage())).getUrl() + "')")  + ";background-repeat:" + ("no-repeat")  + ";}.mgwt-PullToRefresh-text{position:" + ("absolute")  + ";top:" + ("20px")  + ";left:" + ("110px")  + ";display:") + (("inline-block")  + ";font-size:" + ("20px")  + ";}"));
      }
      public java.lang.String arrow(){
  ...
  private void getSliderCssInitializer() {
    getSliderCss = new com.googlecode.mgwt.ui.client.theme.base.SliderCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".mgwt-Slider{display:" + ("inline-block")  + ";width:" + ("277px")  + ";padding-top:" + ("10px")  + ";padding-bottom:" + ("10px")  + ";}.mgwt-Slider-bar{position:" + ("relative")  + ";height:" + ("9px")  + ";background-repeat:" + ("no-repeat"+ ","+ " " +"repeat-x")  + ";-webkit-box-sizing:" + ("padding-box")  + ";-webkit-box-shadow:" + ("2px"+ " " +"2px"+ " " +"4px"+ " " +"#666")  + ";-webkit-border-radius:" + ("4px")  + ";background-image:") + (("-webkit-gradient(linear, left top ,left bottom, from(#0a3b87), color-stop(.5, #4c8de7), color-stop(.95, #6babf5), to(#0a3b87)), -webkit-gradient(linear, left top ,left bottom, from(#929292), color-stop(.5, #f0f0f0), color-stop(.5, #fff), color-stop(.95, #fff), to(#929292))")  + ";}.mgwt-Slider-pointer{position:" + ("relative")  + ";height:" + ("20px")  + ";width:" + ("20px")  + ";right:" + ("-10px")  + ";top:" + ("-6px")  + ";border-radius:" + ("10px")  + ";-webkit-tap-highlight-color:" + ("transparent")  + ";-webkit-box-shadow:" + ("2px"+ " " +"2px"+ " " +"3px"+ " " +"#666")  + ";-webkit-border-radius:" + ("10px")  + ";background-image:" + ("-webkit-gradient(linear, left top, left bottom, from(#aaaaaa), color-stop(.5, #eeeeee), to(#cccccc))") ) + (";}")) : ((".mgwt-Slider{display:" + ("inline-block")  + ";width:" + ("277px")  + ";padding-top:" + ("10px")  + ";padding-bottom:" + ("10px")  + ";}.mgwt-Slider-bar{position:" + ("relative")  + ";height:" + ("9px")  + ";background-repeat:" + ("no-repeat"+ ","+ " " +"repeat-x")  + ";-webkit-box-sizing:" + ("padding-box")  + ";-webkit-box-shadow:" + ("2px"+ " " +"2px"+ " " +"4px"+ " " +"#666")  + ";-webkit-border-radius:" + ("4px")  + ";background-image:") + (("-webkit-gradient(linear, left top ,left bottom, from(#0a3b87), color-stop(.5, #4c8de7), color-stop(.95, #6babf5), to(#0a3b87)), -webkit-gradient(linear, left top ,left bottom, from(#929292), color-stop(.5, #f0f0f0), color-stop(.5, #fff), color-stop(.95, #fff), to(#929292))")  + ";}.mgwt-Slider-pointer{position:" + ("relative")  + ";height:" + ("20px")  + ";width:" + ("20px")  + ";left:" + ("-10px")  + ";top:" + ("-6px")  + ";border-radius:" + ("10px")  + ";-webkit-tap-highlight-color:" + ("transparent")  + ";-webkit-box-shadow:" + ("2px"+ " " +"2px"+ " " +"3px"+ " " +"#666")  + ";-webkit-border-radius:" + ("10px")  + ";background-image:" + ("-webkit-gradient(linear, left top, left bottom, from(#aaaaaa), color-stop(.5, #eeeeee), to(#cccccc))") ) + (";}"));
      }
  ...
  private void getTabBarCssInitializer() {
    getTabBarCss = new com.googlecode.mgwt.ui.client.theme.base.TabBarCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".mgwt-TabPanel{display:" + ("-webkit-box")  + ";-webkit-box-flex:" + ("1")  + ";-webkit-box-orient:" + ("vertical")  + ";width:" + ("100%")  + ";height:" + ("100%")  + ";}.GEEN40JDKQ{display:" + ("-webkit-box")  + ";-webkit-box-flex:" + ("1")  + ";-webkit-box-orient:" + ("vertical")  + ";overflow:" + ("hidden")  + ";}.mgwt-TabBar{display:" + ("-webkit-box")  + ";-webkit-box-orient:") + (("horizontal")  + ";display:" + ("-webkit-box")  + ";-webkit-box-orient:" + ("horizontal")  + ";height:" + ("48px")  + ";border-top:" + ("1px"+ " " +"solid"+ " " +"black")  + ";background-image:" + ("-webkit-gradient(linear, left top, left bottom, from(rgb(46, 46, 46)), color-stop(50%,rgb(22, 22, 22)), color-stop(51%, rgb(0,0,0)), to(rgb(0,0,0)))")  + ";}.mgwt-TabBar-Button{min-width:" + ("60px")  + ";background-color:" + ("transparent")  + ";box-sizing:" + ("content-box")  + ";-webkit-appearance:" + ("none")  + ";-webkit-box-flex:" + ("1") ) + (";margin:" + ("2px")  + ";-webkit-border-radius:" + ("3px")  + ";}.mgwt-TabBar-Button-selected{background-color:" + ("rgba(" + "255"+ ","+ " " +"255"+ ","+ " " +"255"+ ","+ " " +"0.15" + ")")  + ";}.mgwt-TabBar-Button-selected .mgwt-TabBar-Button-text{color:" + ("white")  + ";}.mgwt-TabBar-Button-text{font-size:" + ("9px")  + ";color:" + ("#999995")  + ";text-align:" + ("center")  + ";z-index:" + ("1")  + ";margin-top:" + ("-5px")  + ";}.mgwt-TabBar-Button-icon{margin-right:" + ("auto")  + ";margin-left:") + (("auto")  + ";z-index:" + ("0")  + ";background-image:" + ("-webkit-gradient(linear, 30% 0%, 60% 70%, from(#ccc), to(#888))")  + ";}.mgwt-TabBar-Button-selected .mgwt-TabBar-Button-icon{background-image:" + ("-webkit-gradient(linear, 30% 0%, 60% 70%,  from(#dee8f1), to(#3ec6f9), color-stop(0.6,#7ab3ed),color-stop(0.7,#2f92e6))")  + ";}")) : ((".mgwt-TabPanel{display:" + ("-webkit-box")  + ";-webkit-box-flex:" + ("1")  + ";-webkit-box-orient:" + ("vertical")  + ";width:" + ("100%")  + ";height:" + ("100%")  + ";}.GEEN40JDKQ{display:" + ("-webkit-box")  + ";-webkit-box-flex:" + ("1")  + ";-webkit-box-orient:" + ("vertical")  + ";overflow:" + ("hidden")  + ";}.mgwt-TabBar{display:" + ("-webkit-box")  + ";-webkit-box-orient:") + (("horizontal")  + ";display:" + ("-webkit-box")  + ";-webkit-box-orient:" + ("horizontal")  + ";height:" + ("48px")  + ";border-top:" + ("1px"+ " " +"solid"+ " " +"black")  + ";background-image:" + ("-webkit-gradient(linear, left top, left bottom, from(rgb(46, 46, 46)), color-stop(50%,rgb(22, 22, 22)), color-stop(51%, rgb(0,0,0)), to(rgb(0,0,0)))")  + ";}.mgwt-TabBar-Button{min-width:" + ("60px")  + ";background-color:" + ("transparent")  + ";box-sizing:" + ("content-box")  + ";-webkit-appearance:" + ("none")  + ";-webkit-box-flex:" + ("1") ) + (";margin:" + ("2px")  + ";-webkit-border-radius:" + ("3px")  + ";}.mgwt-TabBar-Button-selected{background-color:" + ("rgba(" + "255"+ ","+ " " +"255"+ ","+ " " +"255"+ ","+ " " +"0.15" + ")")  + ";}.mgwt-TabBar-Button-selected .mgwt-TabBar-Button-text{color:" + ("white")  + ";}.mgwt-TabBar-Button-text{font-size:" + ("9px")  + ";color:" + ("#999995")  + ";text-align:" + ("center")  + ";z-index:" + ("1")  + ";margin-top:" + ("-5px")  + ";}.mgwt-TabBar-Button-icon{margin-left:" + ("auto")  + ";margin-right:") + (("auto")  + ";z-index:" + ("0")  + ";background-image:" + ("-webkit-gradient(linear, 30% 0%, 60% 70%, from(#ccc), to(#888))")  + ";}.mgwt-TabBar-Button-selected .mgwt-TabBar-Button-icon{background-image:" + ("-webkit-gradient(linear, 30% 0%, 60% 70%,  from(#dee8f1), to(#3ec6f9), color-stop(0.6,#7ab3ed),color-stop(0.7,#2f92e6))")  + ";}"));
      }
      public java.lang.String active(){
  ...
  private void utilTextResourceInitializer() {
    utilTextResource = new com.google.gwt.resources.client.TextResource() {
      // jar:file:/C:/Users/marcello/.m2/repository/com/googlecode/mgwt/mgwt/1.1.2/mgwt-1.1.2.jar!/com/googlecode/mgwt/ui/client/theme/base/css/util.css
      public String getText() {
  ...
  private static final java.lang.String externalImage = "data:image/png;base64,";
  private static final java.lang.String externalImage0 = "data:image/png;base64,";
  private static final java.lang.String externalImage1 = "data:image/png;base64,";
  private static final java.lang.String externalImage2 = "data:image/png;base64,";
  private static final java.lang.String externalImage3 = "data:image/png;base64,";
  private static final java.lang.String externalImage4 = "data:image/png;base64,";
  private static final java.lang.String externalImage5 = "data:image/png;base64,";
  private static final java.lang.String externalImage6 = "data:image/png;base64,";
  private static final java.lang.String externalImage7 = "data:image/png;base64,";
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      case 'android_check_checked': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::android_check_checked()();
      case 'android_check_not_checked': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::android_check_not_checked()();
      case 'errorImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::errorImage()();
      case 'inputCheckImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::inputCheckImage()();
      case 'listArrow': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::listArrow()();
      case 'searchClearImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::searchClearImage()();
      case 'searchClearTouchedImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::searchClearTouchedImage()();
      case 'searchSearchImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::searchSearchImage()();
      case 'spinnerImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::spinnerImage()();
      case 'spinnerWhiteImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::spinnerWhiteImage()();
      case 'getButtonBarActionImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarActionImage()();
      case 'getButtonBarArrowDownImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarArrowDownImage()();
      case 'getButtonBarArrowLeftImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarArrowLeftImage()();
      case 'getButtonBarArrowRightImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarArrowRightImage()();
      case 'getButtonBarArrowUpImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarArrowUpImage()();
      case 'getButtonBarBookmarkImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarBookmarkImage()();
      case 'getButtonBarCameraImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarCameraImage()();
      case 'getButtonBarComposeImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarComposeImage()();
      case 'getButtonBarFastForwardImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarFastForwardImage()();
      case 'getButtonBarHighlightImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarHighlightImage()();
      case 'getButtonBarInfoImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarInfoImage()();
      case 'getButtonBarLocateImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarLocateImage()();
      case 'getButtonBarMinusImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarMinusImage()();
      case 'getButtonBarNewImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarNewImage()();
      case 'getButtonBarNextSlideImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarNextSlideImage()();
      case 'getButtonBarOrganizeImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarOrganizeImage()();
      case 'getButtonBarPauseImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarPauseImage()();
      case 'getButtonBarPlayImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarPlayImage()();
      case 'getButtonBarPlusImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarPlusImage()();
      case 'getButtonBarPreviousSlideImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarPreviousSlideImage()();
      case 'getButtonBarRefreshImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarRefreshImage()();
      case 'getButtonBarReplyImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarReplyImage()();
      case 'getButtonBarRewindImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarRewindImage()();
      case 'getButtonBarSearchImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarSearchImage()();
      case 'getButtonBarStopImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarStopImage()();
      case 'getButtonBarTrashImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarTrashImage()();
      case 'tabBarBookMarkImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::tabBarBookMarkImage()();
      case 'tabBarContactsImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::tabBarContactsImage()();
      case 'tabBarDownloadsImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::tabBarDownloadsImage()();
      case 'tabBarFavoritesImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::tabBarFavoritesImage()();
      case 'tabBarFeaturedImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::tabBarFeaturedImage()();
      case 'tabBarHistoryImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::tabBarHistoryImage()();
      case 'tabBarMoreImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::tabBarMoreImage()();
      case 'tabBarMostRecentImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::tabBarMostRecentImage()();
      case 'tabBarMostViewedImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::tabBarMostViewedImage()();
      case 'tabBarSearchImage': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::tabBarSearchImage()();
      case 'getButtonBarButtonCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarButtonCss()();
      case 'getButtonBarCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonBarCss()();
      case 'getButtonCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getButtonCss()();
      case 'getCarouselCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getCarouselCss()();
      case 'getCheckBoxCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getCheckBoxCss()();
      case 'getDialogCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getDialogCss()();
      case 'getGroupingList': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getGroupingList()();
      case 'getHeaderCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getHeaderCss()();
      case 'getInputCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getInputCss()();
      case 'getLayoutCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getLayoutCss()();
      case 'getListCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getListCss()();
      case 'getMainCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getMainCss()();
      case 'getPanelCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getPanelCss()();
      case 'getProgressBarCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getProgressBarCss()();
      case 'getProgressIndicatorCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getProgressIndicatorCss()();
      case 'getPullToRefreshCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getPullToRefreshCss()();
      case 'getScrollPanelCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getScrollPanelCss()();
      case 'getSearchBoxCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getSearchBoxCss()();
      case 'getSliderCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getSliderCss()();
      case 'getTabBarCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getTabBarCss()();
      case 'getUtilCss': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::getUtilCss()();
      case 'utilTextResource': return this.@com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeIPad::utilTextResource()();
    }
    return null;
  }-*/;
}
