...
public class PhoneGapLogService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["com.googlecode.gwtphonegap.client.file.browser.FileErrorException/462052366"] = [
        ,
        ,
        @com.googlecode.gwtphonegap.client.file.browser.FileErrorException_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;Lcom/googlecode/gwtphonegap/client/file/browser/FileErrorException;)
      ];
    
    result["it.mate.gwtcommons.client.mvp.MvpException/3059986541"] = [
        ,
        ,
        @it.mate.gwtcommons.client.mvp.MvpException_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;Lit/mate/gwtcommons/client/mvp/MvpException;)
      ];
    ...
    result["it.mate.gwtcommons.client.utils.NotImplementedViewException/483573632"] = [
        ,
        ,
        @it.mate.gwtcommons.client.utils.NotImplementedViewException_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;Lit/mate/gwtcommons/client/utils/NotImplementedViewException;)
      ];
    
    result["it.mate.gwtcommons.shared.model.CloneablePropertyMissingException/2461171834"] = [
        ,
        ,
        @it.mate.gwtcommons.shared.model.CloneablePropertyMissingException_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;Lit/mate/gwtcommons/shared/model/CloneablePropertyMissingException;)
      ];
    
    result["it.mate.gwtcommons.shared.services.ServiceException/3191961875"] = [
        ,
        ,
        @it.mate.gwtcommons.shared.services.ServiceException_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;Lit/mate/gwtcommons/shared/services/ServiceException;)
      ];
    ...
    result["[Ljava.util.logging.LogRecord;/565203458"] = [
        ,
        ,
        @com.google.gwt.user.client.rpc.core.java.util.logging.LogRecord_Array_Rank_1_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;[Ljava/util/logging/LogRecord;)
      ];
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.googlecode.gwtphonegap.client.file.browser.FileErrorException::class)] = "com.googlecode.gwtphonegap.client.file.browser.FileErrorException/462052366";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@it.mate.gwtcommons.client.mvp.MvpException::class)] = "it.mate.gwtcommons.client.mvp.MvpException/3059986541";
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@it.mate.gwtcommons.client.utils.NotImplementedViewException::class)] = "it.mate.gwtcommons.client.utils.NotImplementedViewException/483573632";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@it.mate.gwtcommons.shared.model.CloneablePropertyMissingException::class)] = "it.mate.gwtcommons.shared.model.CloneablePropertyMissingException/2461171834";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@it.mate.gwtcommons.shared.services.ServiceException::class)] = "it.mate.gwtcommons.shared.services.ServiceException/3191961875";
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@java.util.logging.LogRecord[]::class)] = "[Ljava.util.logging.LogRecord;/565203458";
  ...
  public PhoneGapLogService_TypeSerializer() {
