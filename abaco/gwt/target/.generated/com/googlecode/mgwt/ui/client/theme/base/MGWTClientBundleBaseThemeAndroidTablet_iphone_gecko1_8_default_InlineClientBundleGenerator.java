...
public class MGWTClientBundleBaseThemeAndroidTablet_iphone_gecko1_8_default_InlineClientBundleGenerator implements com.googlecode.mgwt.ui.client.theme.base.MGWTClientBundleBaseThemeAndroidTablet {
  private static MGWTClientBundleBaseThemeAndroidTablet_iphone_gecko1_8_default_InlineClientBundleGenerator _instance0 = new MGWTClientBundleBaseThemeAndroidTablet_iphone_gecko1_8_default_InlineClientBundleGenerator();
  ...
  private void getButtonCssInitializer() {
    getButtonCss = new com.googlecode.mgwt.ui.client.theme.base.ButtonCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".mgwt-Button{display:" + ("block")  + ";position:" + ("relative")  + ";padding:" + ("9px"+ " " +"13px")  + ";margin:" + ("5px")  + ";white-space:" + ("nowrap")  + ";overflow:" + ("hidden")  + ";text-overflow:" + ("ellipsis")  + ";font-size:" + ("19px")  + ";text-align:" + ("center")  + ";-moz-appearance:" + ("none")  + ";}.mgwt-Button-small{padding:") + (("5px"+ " " +"7px")  + ";margin:" + ("2px")  + ";margin-right:" + ("5px")  + ";margin-left:" + ("5px")  + ";font-size:" + ("12px")  + ";}.mgwt-Button-round{border-bottom-right-radius:" + ("16px"+ " " +"16px")  + ";border-bottom-left-radius:" + ("16px"+ " " +"16px")  + ";border-top-right-radius:" + ("16px"+ " " +"16px")  + ";border-top-left-radius:" + ("16px"+ " " +"16px")  + ";}.mgwt-Button{color:" + ("black")  + ";border:" + ("1px"+ " " +"solid"+ " " +"rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0.5" + ")") ) + (";-moz-border-radius:" + ("4px")  + ";border-radius:" + ("4px")  + ";background-image:" + ("-moz-linear-gradient(top, rgb(180, 180, 180), rgb(160, 160, 160))")  + ";}.mgwt-Button-active{color:" + ("#fff")  + ";background-image:" + ("-moz-linear-gradient(top, rgb(82, 163, 196), rgb(62, 143, 176))")  + ";}.mgwt-Button-important{border:" + ("1px"+ " " +"solid"+ " " +"rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0.5" + ")")  + ";background-image:" + ("-moz-linear-gradient(top, rgba(255,59,59,0.70),  rgba(255,0,0,0.80))")  + ";}.mgwt-Button-important.mgwt-Button-active{background-image:" + ("-moz-linear-gradient(top, rgba(255,30,30,0.80), rgba(255,0,0,0.90))")  + ";color:" + ("#fff")  + ";}.mgwt-Button-confirm{border:" + ("1px"+ " " +"solid"+ " " +"rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0.5" + ")")  + ";background-image:") + (("-moz-linear-gradient(top, rgba(115,239,115,0.70), rgba(0,150,0,0.80))")  + ";}.mgwt-Button-confirm.mgwt-Button-active{background-image:" + ("-moz-linear-gradient(top, rgba(100,220,100,0.70), rgba(0,100,0,0.80))")  + ";color:" + ("#fff")  + ";}.mgwt-Button-round{border-bottom-right-radius:" + ("16px"+ " " +"16px")  + ";border-bottom-left-radius:" + ("16px"+ " " +"16px")  + ";border-top-right-radius:" + ("16px"+ " " +"16px")  + ";border-top-left-radius:" + ("16px"+ " " +"16px")  + ";}")) : ((".mgwt-Button{display:" + ("block")  + ";position:" + ("relative")  + ";padding:" + ("9px"+ " " +"13px")  + ";margin:" + ("5px")  + ";white-space:" + ("nowrap")  + ";overflow:" + ("hidden")  + ";text-overflow:" + ("ellipsis")  + ";font-size:" + ("19px")  + ";text-align:" + ("center")  + ";-moz-appearance:" + ("none")  + ";}.mgwt-Button-small{padding:") + (("5px"+ " " +"7px")  + ";margin:" + ("2px")  + ";margin-left:" + ("5px")  + ";margin-right:" + ("5px")  + ";font-size:" + ("12px")  + ";}.mgwt-Button-round{border-bottom-left-radius:" + ("16px"+ " " +"16px")  + ";border-bottom-right-radius:" + ("16px"+ " " +"16px")  + ";border-top-left-radius:" + ("16px"+ " " +"16px")  + ";border-top-right-radius:" + ("16px"+ " " +"16px")  + ";}.mgwt-Button{color:" + ("black")  + ";border:" + ("1px"+ " " +"solid"+ " " +"rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0.5" + ")") ) + (";-moz-border-radius:" + ("4px")  + ";border-radius:" + ("4px")  + ";background-image:" + ("-moz-linear-gradient(top, rgb(180, 180, 180), rgb(160, 160, 160))")  + ";}.mgwt-Button-active{color:" + ("#fff")  + ";background-image:" + ("-moz-linear-gradient(top, rgb(82, 163, 196), rgb(62, 143, 176))")  + ";}.mgwt-Button-important{border:" + ("1px"+ " " +"solid"+ " " +"rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0.5" + ")")  + ";background-image:" + ("-moz-linear-gradient(top, rgba(255,59,59,0.70),  rgba(255,0,0,0.80))")  + ";}.mgwt-Button-important.mgwt-Button-active{background-image:" + ("-moz-linear-gradient(top, rgba(255,30,30,0.80), rgba(255,0,0,0.90))")  + ";color:" + ("#fff")  + ";}.mgwt-Button-confirm{border:" + ("1px"+ " " +"solid"+ " " +"rgba(" + "0"+ ","+ " " +"0"+ ","+ " " +"0"+ ","+ " " +"0.5" + ")")  + ";background-image:") + (("-moz-linear-gradient(top, rgba(115,239,115,0.70), rgba(0,150,0,0.80))")  + ";}.mgwt-Button-confirm.mgwt-Button-active{background-image:" + ("-moz-linear-gradient(top, rgba(100,220,100,0.70), rgba(0,100,0,0.80))")  + ";color:" + ("#fff")  + ";}.mgwt-Button-round{border-bottom-left-radius:" + ("16px"+ " " +"16px")  + ";border-bottom-right-radius:" + ("16px"+ " " +"16px")  + ";border-top-left-radius:" + ("16px"+ " " +"16px")  + ";border-top-right-radius:" + ("16px"+ " " +"16px")  + ";}"));
      }
      public java.lang.String active(){
  ...
  private void getMainCssInitializer() {
    getMainCss = new com.googlecode.mgwt.ui.client.theme.base.MainCss() {
      ...
      public String getText() {
        return ("*{margin:" + ("0")  + ";padding:" + ("0")  + ";font-family:" + ("Helvetica"+ ","+ " " +"sans-serif")  + ";-moz-user-select:" + ("none")  + ";}input,textarea{-moz-user-select:" + ("text")  + ";}body{width:" + ("100%")  + ";height:" + ("100%")  + ";position:" + ("absolute")  + ";color:" + ("white")  + ";background-attachment:" + ("fixed")  + ";background-image:") + (("-moz-linear-gradient(top, #000000, rgb(46, 54, 60))")  + ";}input:FOCUS,button:FOCUS,button{outline:" + ("none")  + ";}");
      }
    }
    ;
  }
  ...
  private void getPullToRefreshCssInitializer() {
    getPullToRefreshCss = new com.googlecode.mgwt.ui.client.theme.base.PullToRefreshCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".mgwt-PullToRefresh{position:" + ("relative")  + ";bottom:" + ("0")  + ";right:" + ("0")  + ";width:" + ("100%")  + ";height:" + ("70px")  + ";}.mgwt-PullToRefresh-arrow{height:" + ((MGWTClientBundleBaseThemeAndroidTablet_iphone_gecko1_8_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getHeight() + "px")  + ";width:" + ((MGWTClientBundleBaseThemeAndroidTablet_iphone_gecko1_8_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (MGWTClientBundleBaseThemeAndroidTablet_iphone_gecko1_8_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getSafeUri().asString() + "\") -" + (MGWTClientBundleBaseThemeAndroidTablet_iphone_gecko1_8_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getLeft() + "px -" + (MGWTClientBundleBaseThemeAndroidTablet_iphone_gecko1_8_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";margin-right:") + (("50px")  + ";top:" + ("20px")  + ";width:" + ("40px")  + ";height:" + ("40px")  + ";background-repeat:" + ("no-repeat")  + ";-moz-transform-origin:" + ("12px"+ " " +"9px")  + ";}.mgwt-PullToRefresh-spinner{position:" + ("absolute")  + ";margin-right:" + ("50px")  + ";top:" + ("10px")  + ";width:" + ("50px")  + ";height:" + ("50px") ) + (";}.mgwt-PullToRefresh-error{position:" + ("absolute")  + ";margin-right:" + ("50px")  + ";top:" + ("15px")  + ";width:" + ("50px")  + ";height:" + ("50px")  + ";background-image:" + ("url('" + ((com.google.gwt.resources.client.DataResource)(MGWTClientBundleBaseThemeAndroidTablet_iphone_gecko1_8_default_InlineClientBundleGenerator.this.errorImage())).getUrl() + "')")  + ";background-repeat:" + ("no-repeat")  + ";}.mgwt-PullToRefresh-text{position:" + ("absolute")  + ";top:" + ("20px")  + ";right:" + ("110px")  + ";display:") + (("inline-block")  + ";font-size:" + ("20px")  + ";}")) : ((".mgwt-PullToRefresh{position:" + ("relative")  + ";bottom:" + ("0")  + ";left:" + ("0")  + ";width:" + ("100%")  + ";height:" + ("70px")  + ";}.mgwt-PullToRefresh-arrow{height:" + ((MGWTClientBundleBaseThemeAndroidTablet_iphone_gecko1_8_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getHeight() + "px")  + ";width:" + ((MGWTClientBundleBaseThemeAndroidTablet_iphone_gecko1_8_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (MGWTClientBundleBaseThemeAndroidTablet_iphone_gecko1_8_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getSafeUri().asString() + "\") -" + (MGWTClientBundleBaseThemeAndroidTablet_iphone_gecko1_8_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getLeft() + "px -" + (MGWTClientBundleBaseThemeAndroidTablet_iphone_gecko1_8_default_InlineClientBundleGenerator.this.getButtonBarNextSlideImage()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";margin-left:") + (("50px")  + ";top:" + ("20px")  + ";width:" + ("40px")  + ";height:" + ("40px")  + ";background-repeat:" + ("no-repeat")  + ";-moz-transform-origin:" + ("12px"+ " " +"9px")  + ";}.mgwt-PullToRefresh-spinner{position:" + ("absolute")  + ";margin-left:" + ("50px")  + ";top:" + ("10px")  + ";width:" + ("50px")  + ";height:" + ("50px") ) + (";}.mgwt-PullToRefresh-error{position:" + ("absolute")  + ";margin-left:" + ("50px")  + ";top:" + ("15px")  + ";width:" + ("50px")  + ";height:" + ("50px")  + ";background-image:" + ("url('" + ((com.google.gwt.resources.client.DataResource)(MGWTClientBundleBaseThemeAndroidTablet_iphone_gecko1_8_default_InlineClientBundleGenerator.this.errorImage())).getUrl() + "')")  + ";background-repeat:" + ("no-repeat")  + ";}.mgwt-PullToRefresh-text{position:" + ("absolute")  + ";top:" + ("20px")  + ";left:" + ("110px")  + ";display:") + (("inline-block")  + ";font-size:" + ("20px")  + ";}"));
      }
      public java.lang.String arrow(){
  ...
  private void getSliderCssInitializer() {
    getSliderCss = new com.googlecode.mgwt.ui.client.theme.base.SliderCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".mgwt-Slider{display:" + ("inline-block")  + ";width:" + ("277px")  + ";padding-top:" + ("10px")  + ";padding-bottom:" + ("10px")  + ";}.mgwt-Slider-bar{position:" + ("relative")  + ";height:" + ("4px")  + ";background-repeat:" + ("repeat-x")  + ";-moz-box-sizing:" + ("padding-box")  + ";background-image:" + ("-moz-linear-gradient(top,  rgb(146, 199, 0), rgb(126, 179, 0))")  + ";}.mgwt-Slider-pointer{position:" + ("relative")  + ";height:") + (("26px")  + ";width:" + ("26px")  + ";right:" + ("-10px")  + ";top:" + ("-12px")  + ";border:" + ("1px"+ " " +"solid"+ " " +"rgba(" + "255"+ ","+ " " +"255"+ ","+ " " +"255"+ ","+ " " +"0.5" + ")")  + ";border-radius:" + ("15px")  + ";-moz-tap-highlight-color:" + ("transparent")  + ";-moz-border-radius:" + ("15px")  + ";border-radius:" + ("15px")  + ";background-image:" + ("-moz-radial-gradient(radial, 50% 50%, 0, circle closest-side , rgb(146, 199, 0), rgb(146, 199, 0) 10% , rgba(126, 179, 0, 0.7) 11%,  rgba(255, 255, 255, 1) 15%  , rgba(126, 179, 0, 0.3) 16%, rgba(126, 179, 0, 0.4))")  + ";}")) : ((".mgwt-Slider{display:" + ("inline-block")  + ";width:" + ("277px")  + ";padding-top:" + ("10px")  + ";padding-bottom:" + ("10px")  + ";}.mgwt-Slider-bar{position:" + ("relative")  + ";height:" + ("4px")  + ";background-repeat:" + ("repeat-x")  + ";-moz-box-sizing:" + ("padding-box")  + ";background-image:" + ("-moz-linear-gradient(top,  rgb(146, 199, 0), rgb(126, 179, 0))")  + ";}.mgwt-Slider-pointer{position:" + ("relative")  + ";height:") + (("26px")  + ";width:" + ("26px")  + ";left:" + ("-10px")  + ";top:" + ("-12px")  + ";border:" + ("1px"+ " " +"solid"+ " " +"rgba(" + "255"+ ","+ " " +"255"+ ","+ " " +"255"+ ","+ " " +"0.5" + ")")  + ";border-radius:" + ("15px")  + ";-moz-tap-highlight-color:" + ("transparent")  + ";-moz-border-radius:" + ("15px")  + ";border-radius:" + ("15px")  + ";background-image:" + ("-moz-radial-gradient(radial, 50% 50%, 0, circle closest-side , rgb(146, 199, 0), rgb(146, 199, 0) 10% , rgba(126, 179, 0, 0.7) 11%,  rgba(255, 255, 255, 1) 15%  , rgba(126, 179, 0, 0.3) 16%, rgba(126, 179, 0, 0.4))")  + ";}"));
      }
  ...
  private void getTabBarCssInitializer() {
    getTabBarCss = new com.googlecode.mgwt.ui.client.theme.base.TabBarCss() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".mgwt-TabPanel{display:" + ("-webkit-box")  + ";-webkit-box-flex:" + ("1")  + ";-webkit-box-orient:" + ("vertical")  + ";width:" + ("100%")  + ";height:" + ("100%")  + ";}.GOE-WOTBKQ{display:" + ("-webkit-box")  + ";-webkit-box-flex:" + ("1")  + ";-webkit-box-orient:" + ("vertical")  + ";overflow:" + ("hidden")  + ";}.mgwt-TabBar{display:" + ("-webkit-box")  + ";-webkit-box-orient:") + (("horizontal")  + ";display:" + ("-moz-box")  + ";-moz-box-orient:" + ("horizontal")  + ";}.mgwt-TabBar-Button-selected{background-image:" + ("-moz-linear-gradient(top, rgba(255,255,255,0), rgba(255,255,255,0) 75%, rgba(82, 163, 196, 1) 76%, rgba(82, 163, 196, 1))")  + ";}.mgwt-TabBar-Button{min-width:" + ("60px")  + ";background-color:" + ("transparent")  + ";box-sizing:" + ("content-box")  + ";-moz-appearance:" + ("none")  + ";-moz-box-flex:" + ("1")  + ";}.mgwt-TabBar{min-height:" + ("40px")  + ";background-color:" + ("inherit") ) + (";border-bottom:" + ("2px"+ " " +"solid"+ " " +"#52a3c4")  + ";}.mgwt-TabBar-Button{top:" + ("10px")  + ";min-height:" + ("30px")  + ";margin-right:" + ("10px")  + ";}.mgwt-TabBar-Button-text{white-space:" + ("-webkit-nowrap")  + ";white-space:" + ("nowrap")  + ";font-size:" + ("12px")  + ";color:" + ("white")  + ";text-align:" + ("center")  + ";}.mgwt-TabBar-Button-icon{margin-right:" + ("auto")  + ";margin-left:") + (("auto")  + ";background-color:" + ("#52a3c4")  + ";}.mgwt-TabBar-Button-selected .mgwt-TabBar-Button-icon{background-color:" + ("white")  + ";}")) : ((".mgwt-TabPanel{display:" + ("-webkit-box")  + ";-webkit-box-flex:" + ("1")  + ";-webkit-box-orient:" + ("vertical")  + ";width:" + ("100%")  + ";height:" + ("100%")  + ";}.GOE-WOTBKQ{display:" + ("-webkit-box")  + ";-webkit-box-flex:" + ("1")  + ";-webkit-box-orient:" + ("vertical")  + ";overflow:" + ("hidden")  + ";}.mgwt-TabBar{display:" + ("-webkit-box")  + ";-webkit-box-orient:") + (("horizontal")  + ";display:" + ("-moz-box")  + ";-moz-box-orient:" + ("horizontal")  + ";}.mgwt-TabBar-Button-selected{background-image:" + ("-moz-linear-gradient(top, rgba(255,255,255,0), rgba(255,255,255,0) 75%, rgba(82, 163, 196, 1) 76%, rgba(82, 163, 196, 1))")  + ";}.mgwt-TabBar-Button{min-width:" + ("60px")  + ";background-color:" + ("transparent")  + ";box-sizing:" + ("content-box")  + ";-moz-appearance:" + ("none")  + ";-moz-box-flex:" + ("1")  + ";}.mgwt-TabBar{min-height:" + ("40px")  + ";background-color:" + ("inherit") ) + (";border-bottom:" + ("2px"+ " " +"solid"+ " " +"#52a3c4")  + ";}.mgwt-TabBar-Button{top:" + ("10px")  + ";min-height:" + ("30px")  + ";margin-left:" + ("10px")  + ";}.mgwt-TabBar-Button-text{white-space:" + ("-webkit-nowrap")  + ";white-space:" + ("nowrap")  + ";font-size:" + ("12px")  + ";color:" + ("white")  + ";text-align:" + ("center")  + ";}.mgwt-TabBar-Button-icon{margin-left:" + ("auto")  + ";margin-right:") + (("auto")  + ";background-color:" + ("#52a3c4")  + ";}.mgwt-TabBar-Button-selected .mgwt-TabBar-Button-icon{background-color:" + ("white")  + ";}"));
      }
      public java.lang.String active(){
