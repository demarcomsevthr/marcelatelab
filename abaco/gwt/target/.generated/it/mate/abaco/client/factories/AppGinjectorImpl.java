...
public class AppGinjectorImpl implements it.mate.abaco.client.factories.AppGinjector {
  public it.mate.abaco.client.view.AbacoView getAbacoView() {
    return get_Key$type$it$mate$abaco$client$view$AbacoView$_annotation$$none$$();
  }
  ...
  public it.mate.abaco.client.view.HomeView getHomeView() {
    return get_Key$type$it$mate$abaco$client$view$HomeView$_annotation$$none$$();
  }
  
  public it.mate.abaco.client.activities.mapper.MainActivityMapper getMainActivityMapper() {
    return get_Key$type$it$mate$abaco$client$activities$mapper$MainActivityMapper$_annotation$$none$$();
  }
  ...
  /**
   * Binding for it.mate.abaco.client.view.HomeView declared at:
   *   Implicit binding for Key[type=it.mate.abaco.client.view.HomeView, annotation=[none]]
   */
  private void memberInject_Key$type$it$mate$abaco$client$view$HomeView$_annotation$$none$$(it.mate.abaco.client.view.HomeView injectee) {
    
  }
  
  private it.mate.abaco.client.view.HomeView create_Key$type$it$mate$abaco$client$view$HomeView$_annotation$$none$$() {
    Object created = GWT.create(it.mate.abaco.client.view.HomeView.class);
    assert created instanceof it.mate.abaco.client.view.HomeView;
    it.mate.abaco.client.view.HomeView result = (it.mate.abaco.client.view.HomeView) created;
    
    memberInject_Key$type$it$mate$abaco$client$view$HomeView$_annotation$$none$$(result);
    return result;
  }
   ...
   *   Implicit binding for Key[type=it.mate.abaco.client.view.HomeView, annotation=[none]]
   */
  private it.mate.abaco.client.view.HomeView get_Key$type$it$mate$abaco$client$view$HomeView$_annotation$$none$$() {
    return create_Key$type$it$mate$abaco$client$view$HomeView$_annotation$$none$$();
  }
  ...
  /**
   * Binding for it.mate.abaco.client.activities.mapper.MainActivityMapper declared at:
   *   it.mate.abaco.client.activities.mapper.MainActivityMapper it.mate.abaco.client.factories.AppGinModule.getMainActivityMapper()
   */
  private native it.mate.abaco.client.activities.mapper.MainActivityMapper it$mate$abaco$client$factories$AppGinModule_getMainActivityMapper_methodInjection(it.mate.abaco.client.factories.AppGinModule injectee) /*-{
    return injectee.@it.mate.abaco.client.factories.AppGinModule::getMainActivityMapper()();
  }-*/;
  
  private it.mate.abaco.client.activities.mapper.MainActivityMapper create_Key$type$it$mate$abaco$client$activities$mapper$MainActivityMapper$_annotation$$none$$() {
    return it$mate$abaco$client$factories$AppGinModule_getMainActivityMapper_methodInjection(new it.mate.abaco.client.factories.AppGinModule());
  }
   ...
   *   it.mate.abaco.client.activities.mapper.MainActivityMapper it.mate.abaco.client.factories.AppGinModule.getMainActivityMapper()
   */
  private it.mate.abaco.client.activities.mapper.MainActivityMapper get_Key$type$it$mate$abaco$client$activities$mapper$MainActivityMapper$_annotation$$none$$() {
    return create_Key$type$it$mate$abaco$client$activities$mapper$MainActivityMapper$_annotation$$none$$();
  }
  ...
  /**
   * Binding for it.mate.abaco.client.view.AbacoView declared at:
   *   Implicit binding for Key[type=it.mate.abaco.client.view.AbacoView, annotation=[none]]
   */
  private void memberInject_Key$type$it$mate$abaco$client$view$AbacoView$_annotation$$none$$(it.mate.abaco.client.view.AbacoView injectee) {
    
  }
  
  private it.mate.abaco.client.view.AbacoView create_Key$type$it$mate$abaco$client$view$AbacoView$_annotation$$none$$() {
    Object created = GWT.create(it.mate.abaco.client.view.AbacoView.class);
    assert created instanceof it.mate.abaco.client.view.AbacoView;
    it.mate.abaco.client.view.AbacoView result = (it.mate.abaco.client.view.AbacoView) created;
    
    memberInject_Key$type$it$mate$abaco$client$view$AbacoView$_annotation$$none$$(result);
    return result;
  }
   ...
   *   Implicit binding for Key[type=it.mate.abaco.client.view.AbacoView, annotation=[none]]
   */
  private it.mate.abaco.client.view.AbacoView get_Key$type$it$mate$abaco$client$view$AbacoView$_annotation$$none$$() {
    return create_Key$type$it$mate$abaco$client$view$AbacoView$_annotation$$none$$();
  }
