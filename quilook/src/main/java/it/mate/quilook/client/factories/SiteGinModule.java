...
import it.mate.econyx.client.view.site.BlogDiscussionViewImpl;
...
public class SiteGinModule extends AbstractGinModule {
  ...
  protected void configure() {
     ...
     * 14/06/2013
     * 
     * TODO: togliere queste dipendenze creando un ancestor di SiteClientFactoryImpl in econyx-core
     * 
     */
    ...
    bind(BlogDiscussionView.class).to(BlogDiscussionViewImpl.class);
