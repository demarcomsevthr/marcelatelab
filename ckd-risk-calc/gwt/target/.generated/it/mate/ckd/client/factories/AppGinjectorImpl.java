...
public class AppGinjectorImpl implements it.mate.ckd.client.factories.AppGinjector {
  ...
  public it.mate.ckd.client.view.CKDInputView getCKDInputView() {
    return get_Key$type$it$mate$ckd$client$view$CKDInputView$_annotation$$none$$();
  }
  
  public it.mate.ckd.client.view.CKDOutputView getCKDOutputView() {
    return get_Key$type$it$mate$ckd$client$view$CKDOutputView$_annotation$$none$$();
  }
  ...
  public it.mate.ckd.client.view.HomeView getHomeView() {
    return get_Key$type$it$mate$ckd$client$view$HomeView$_annotation$$none$$();
  }
  
  public it.mate.ckd.client.activities.mapper.MainActivityMapper getMainActivityMapper() {
    return get_Key$type$it$mate$ckd$client$activities$mapper$MainActivityMapper$_annotation$$none$$();
  }
  ...
  /**
   * Binding for it.mate.ckd.client.activities.mapper.MainActivityMapper declared at:
   *   it.mate.ckd.client.activities.mapper.MainActivityMapper it.mate.ckd.client.factories.AppGinModule.getMainActivityMapper()
   */
  private native it.mate.ckd.client.activities.mapper.MainActivityMapper it$mate$ckd$client$factories$AppGinModule_getMainActivityMapper_methodInjection(it.mate.ckd.client.factories.AppGinModule injectee) /*-{
    return injectee.@it.mate.ckd.client.factories.AppGinModule::getMainActivityMapper()();
  }-*/;
  
  private it.mate.ckd.client.activities.mapper.MainActivityMapper create_Key$type$it$mate$ckd$client$activities$mapper$MainActivityMapper$_annotation$$none$$() {
    return it$mate$ckd$client$factories$AppGinModule_getMainActivityMapper_methodInjection(new it.mate.ckd.client.factories.AppGinModule());
  }
   ...
   *   it.mate.ckd.client.activities.mapper.MainActivityMapper it.mate.ckd.client.factories.AppGinModule.getMainActivityMapper()
   */
  private it.mate.ckd.client.activities.mapper.MainActivityMapper get_Key$type$it$mate$ckd$client$activities$mapper$MainActivityMapper$_annotation$$none$$() {
    return create_Key$type$it$mate$ckd$client$activities$mapper$MainActivityMapper$_annotation$$none$$();
  }
  ...
  /**
   * Binding for it.mate.ckd.client.view.HomeView declared at:
   *   Implicit binding for Key[type=it.mate.ckd.client.view.HomeView, annotation=[none]]
   */
  private void memberInject_Key$type$it$mate$ckd$client$view$HomeView$_annotation$$none$$(it.mate.ckd.client.view.HomeView injectee) {
    
  }
  
  private it.mate.ckd.client.view.HomeView create_Key$type$it$mate$ckd$client$view$HomeView$_annotation$$none$$() {
    Object created = GWT.create(it.mate.ckd.client.view.HomeView.class);
    assert created instanceof it.mate.ckd.client.view.HomeView;
    it.mate.ckd.client.view.HomeView result = (it.mate.ckd.client.view.HomeView) created;
    
    memberInject_Key$type$it$mate$ckd$client$view$HomeView$_annotation$$none$$(result);
    return result;
  }
   ...
   *   Implicit binding for Key[type=it.mate.ckd.client.view.HomeView, annotation=[none]]
   */
  private it.mate.ckd.client.view.HomeView get_Key$type$it$mate$ckd$client$view$HomeView$_annotation$$none$$() {
    return create_Key$type$it$mate$ckd$client$view$HomeView$_annotation$$none$$();
  }
  
  
  
  /**
   * Binding for it.mate.ckd.client.view.CKDInputView declared at:
   *   Implicit binding for Key[type=it.mate.ckd.client.view.CKDInputView, annotation=[none]]
   */
  private void memberInject_Key$type$it$mate$ckd$client$view$CKDInputView$_annotation$$none$$(it.mate.ckd.client.view.CKDInputView injectee) {
    
  }
  
  private it.mate.ckd.client.view.CKDInputView create_Key$type$it$mate$ckd$client$view$CKDInputView$_annotation$$none$$() {
    Object created = GWT.create(it.mate.ckd.client.view.CKDInputView.class);
    assert created instanceof it.mate.ckd.client.view.CKDInputView;
    it.mate.ckd.client.view.CKDInputView result = (it.mate.ckd.client.view.CKDInputView) created;
    
    memberInject_Key$type$it$mate$ckd$client$view$CKDInputView$_annotation$$none$$(result);
    return result;
  }
   ...
   *   Implicit binding for Key[type=it.mate.ckd.client.view.CKDInputView, annotation=[none]]
   */
  private it.mate.ckd.client.view.CKDInputView get_Key$type$it$mate$ckd$client$view$CKDInputView$_annotation$$none$$() {
    return create_Key$type$it$mate$ckd$client$view$CKDInputView$_annotation$$none$$();
  }
  
  
  
  /**
   * Binding for it.mate.ckd.client.view.CKDOutputView declared at:
   *   Implicit binding for Key[type=it.mate.ckd.client.view.CKDOutputView, annotation=[none]]
   */
  private void memberInject_Key$type$it$mate$ckd$client$view$CKDOutputView$_annotation$$none$$(it.mate.ckd.client.view.CKDOutputView injectee) {
    
  }
  
  private it.mate.ckd.client.view.CKDOutputView create_Key$type$it$mate$ckd$client$view$CKDOutputView$_annotation$$none$$() {
    Object created = GWT.create(it.mate.ckd.client.view.CKDOutputView.class);
    assert created instanceof it.mate.ckd.client.view.CKDOutputView;
    it.mate.ckd.client.view.CKDOutputView result = (it.mate.ckd.client.view.CKDOutputView) created;
    
    memberInject_Key$type$it$mate$ckd$client$view$CKDOutputView$_annotation$$none$$(result);
    return result;
  }
   ...
   *   Implicit binding for Key[type=it.mate.ckd.client.view.CKDOutputView, annotation=[none]]
   */
  private it.mate.ckd.client.view.CKDOutputView get_Key$type$it$mate$ckd$client$view$CKDOutputView$_annotation$$none$$() {
    return create_Key$type$it$mate$ckd$client$view$CKDOutputView$_annotation$$none$$();
  }
