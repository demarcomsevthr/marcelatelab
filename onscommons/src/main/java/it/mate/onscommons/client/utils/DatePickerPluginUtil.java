...
public class DatePickerPluginUtil {
  ...
  private static native void execImpl (String action, JsDateTimeResult value, JsCallback success, JsCallback failure) /*-{
    var jsSuccess = $entry(function(results) {
      success.@it.mate.onscommons.client.utils.DatePickerPluginUtil.JsCallback::execute(Lcom/google/gwt/core/client/JavaScriptObject;)(results);
    });
    var jsFailure = $entry(function(err) {
      failure.@it.mate.onscommons.client.utils.DatePickerPluginUtil.JsCallback::execute(Lcom/google/gwt/core/client/JavaScriptObject;)(err);
    });
