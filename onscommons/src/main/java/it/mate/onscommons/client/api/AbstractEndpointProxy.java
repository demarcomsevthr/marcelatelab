package it.mate.onscommons.client.api;
...
//private static final String AUTH_SCOPES = "https://www.googleapis.com/auth/userinfo.profile"; // non funziona!
  ...
  private native void createGlobalInitEndpointImpl(AbstractEndpointProxy proxy) /*-{
    $wnd._proxyInitEndpointCallback = $entry(function() {
      proxy.@it.mate.onscommons.client.api.AbstractEndpointProxy::initEndpointApi()();
    });
  }-*/;
   ...
   * 
    if (new Date().getTime() < localStorage.expires_at) {
      success.@it.mate.onscommons.client.api.AbstractEndpointProxy.Callback::execute(Lcom/google/gwt/core/client/JavaScriptObject;)(localStorage.token);
  ...
  private native void getTokenFromStorageImpl(String clientId, String clientSecret, Callback success, Callback failure) /*-{
    if (localStorage.refresh_token) {
      ...
      $wnd.$.post('https://accounts.google.com/o/oauth2/token', {
        ...
        failure.@it.mate.onscommons.client.api.AbstractEndpointProxy.Callback::execute(Lcom/google/gwt/core/client/JavaScriptObject;)(response.responseJSON);
      });
    } else {
      failure.@it.mate.onscommons.client.api.AbstractEndpointProxy.Callback::execute(Lcom/google/gwt/core/client/JavaScriptObject;)();
    }
  }-*/;
  ...
  private native void signInMobileImpl (Boolean mode, String clientId, String clientSecret, String scopes, Callback success, Callback failure) /*-{
    ...
    var loadstartHandler = function(e) {
        ...
        if (code) {
          ...
          failure.@it.mate.onscommons.client.api.AbstractEndpointProxy.Callback::execute(Lcom/google/gwt/core/client/JavaScriptObject;)(error[1]);
        }
