...
public class ContactsPlugin {
  ...
  protected static native void pickContactImpl (JSOSuccess success, JSOStringCallback failure) /*-{
    var jsSuccess = $entry(function(contact) {
      success.@it.mate.onscommons.client.utils.callbacks.JSOSuccess::handle(Lcom/google/gwt/core/client/JavaScriptObject;)(contact);
    });
    var jsFailure = $entry(function(err) {
      failure.@it.mate.onscommons.client.utils.callbacks.JSOStringCallback::handle(Ljava/lang/String;)(err);
    });
