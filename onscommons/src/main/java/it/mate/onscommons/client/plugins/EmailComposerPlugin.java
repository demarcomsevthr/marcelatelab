...
public class EmailComposerPlugin {
  ...
  private static native void callPluginImpl (String methodName, String subject, String body,
    ...
    var jsSuccess = $entry(function(message) {
      success.@it.mate.onscommons.client.plugins.EmailComposerPlugin.JSOSuccess::handleEvent(Lcom/google/gwt/core/client/JavaScriptObject;)(message);
    });
    var jsFailure = $entry(function(message) {
      failure.@it.mate.onscommons.client.plugins.EmailComposerPlugin.JSOFailure::handleEvent(Lcom/google/gwt/core/client/JavaScriptObject;)(message);
    });
