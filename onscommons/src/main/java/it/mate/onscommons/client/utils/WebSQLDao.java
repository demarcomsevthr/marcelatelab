    ...
    private static native JavaScriptObject openDatabaseImpl (String name, String version, Long estimatedSize, DatabaseCallback creationCallback) /*-{
      ...
      if (creationCallback != null) {
        jsCreationCallback = $entry(function(db) {
          creationCallback.@it.mate.onscommons.client.utils.WebSQLDao.DatabaseCallback::handleEvent(Lit/mate/onscommons/client/utils/WebSQLDao$WindowDatabase;)(db);
        });
      }
    ...
    protected final native void changeVersionImpl(String oldVersion, String newVersion, SQLTransactionCallback callback, SQLVoidCallback successCallback) /*-{
      ...
      if (callback != null) {
        jsCallback = $entry(function(tr) {
          callback.@it.mate.onscommons.client.utils.WebSQLDao.SQLTransactionCallback::handleEvent(Lit/mate/onscommons/client/utils/WebSQLDao$SQLTransaction;)(tr);
        });
      }
      var jsSuccessCallback = null;
      if (successCallback != null) {
        jsSuccessCallback = $entry(function() {
          successCallback.@it.mate.onscommons.client.utils.WebSQLDao.SQLVoidCallback::handleEvent()();
        });
      }
    ...
    protected final native void transactionImpl(SQLTransactionCallback callback, SQLTransactionErrorCallback errorCallback, SQLVoidCallback successCallback) /*-{
      ...
      if (errorCallback != null) {
        jsErrorCallback = $entry(function(er) {
          errorCallback.@it.mate.onscommons.client.utils.WebSQLDao.SQLTransactionErrorCallback::handleEvent(Lit/mate/onscommons/client/utils/WebSQLDao$SQLError;)(er);
        });
      } else {
        jsErrorCallback = $entry(function(er) {
    ...
    protected final native void executeSqlImpl (String sqlStatement, JsArrayMixed arguments, SQLStatementCallback callback, SQLStatementErrorCallback errorCallback) /*-{
      ...
      if (callback != null) {
        jsCallback = $entry(function(tr, rs) {
          callback.@it.mate.onscommons.client.utils.WebSQLDao.SQLStatementCallback::handleEvent(Lit/mate/onscommons/client/utils/WebSQLDao$SQLTransaction;Lit/mate/onscommons/client/utils/WebSQLDao$SQLResultSet;)(tr, rs);
        });
      }
      var jsErrorCallback = null;
      if (errorCallback != null) {
        jsErrorCallback = $entry(function(tr, er) {
          errorCallback.@it.mate.onscommons.client.utils.WebSQLDao.SQLStatementErrorCallback::handleEvent(Lit/mate/onscommons/client/utils/WebSQLDao$SQLTransaction;Lit/mate/onscommons/client/utils/WebSQLDao$SQLError;)(tr, er);
        });
      } else {
        jsErrorCallback = $entry(function(tr, er) {
          var txt = @it.mate.onscommons.client.utils.JSONUtils::stringify(Lcom/google/gwt/core/client/JavaScriptObject;)(er);
