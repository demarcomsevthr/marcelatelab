package it.mate.copymob.client.utils;
...
public class AnimitUtils {
  ...
  public static native void showComposeControlbar(Element elem, int x0, int y0, int x1, int y1, String width, String height) /*-{
    $wnd.animit(elem)
      ...
      .queue({
        css: @it.mate.copymob.client.utils.AnimitUtils::hiddenStyleControlbar(II)(x0, y0),
        duration: 0
      })
      .queue({
        css: @it.mate.copymob.client.utils.AnimitUtils::visibleStyleControlbar(IILjava/lang/String;Ljava/lang/String;)(x1, y1, width, height),
        duration: @it.mate.copymob.client.utils.AnimitUtils::CONTROLBAR_DURATION
      })
      .play();
  }-*/;
