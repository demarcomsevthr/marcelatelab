...
public interface AppClientFactory_SAVE extends BaseClientFactory<AppGinjector> {

  public static AppClientFactory_SAVE IMPL = Initializer.create();
  ...
  */
  ...
  class Initializer {
    private static AppClientFactory_SAVE create() {
      String startupModule = GwtUtils.getJSVar("startupModule", null);
      AppClientFactory_SAVE clientFactory = null;
