...
public class SiteClientFactoryCoreImpl <G extends CoreGinjector> extends BaseClientFactoryImpl<G> 
    implements AppClientFactoryCore<G>, SiteClientFactory, PortalSessionStateChangeEvent.Handler, PortalPageChangingEvent.Handler {
