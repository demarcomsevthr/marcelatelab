...
//      popupMsg = "Maybe data connection is not active";
  ...
  public static void setUseNfc(boolean value) {
    PhgUtils.setLocalStorageItem("PPNUseNfc", ""+value);
    PhgUtils.reloadApp();
  }
  
  public static boolean isUseNfc() {
    String value = PhgUtils.getLocalStorageItem("PPNUseNfc");
    if (value != null) {
      return "true".equals(value);
    } else {
      return true;
...
//          goToPrevious();
  ...
  public void doTestFile() {
    ...
    if (FileSystemPlugin.isInstalled()) {
      ...
      FileSystemPlugin.testPlugin("www/main/data/file1.zdat", "protons/workArea", new Delegate<String>() {
      ...
      /*
      if ((testNumber % 2) == 0) {
        FileSystemPlugin.copyApplicationFileToTmpDir("www/data/test.txt", "protons/workArea", new Delegate<String>() {
          public void execute(String result) {
            PhgUtils.log("COPIED FILE " + result);
          }
        });
      } else {
        FileSystemPlugin.deleteTmpDir("protons/workArea", new Delegate<String>() {
          public void execute(String result) {
  ...
  public static void setUseDownloadedFiles(boolean value) {
    PhgUtils.setLocalStorageItem("PPNUseDownloadedFiles", ""+value);
  }
  
  public static boolean isUseDownloadedFiles() {
    String value = PhgUtils.getLocalStorageItem("PPNUseDownloadedFiles");
    if (value != null) {
      return "true".equals(value);
    } else {
      return false;
        ...
        public void execute(List<PrincipioAttivo> ingredients) {
          ...
          IterationUtil.create(ingredients, new IterationUtil.ItemDelegate<PrincipioAttivo>() {
            public void handleItem(PrincipioAttivo ingredient, final IterationUtil<PrincipioAttivo> iteration) {
              String baseUrl = "http://protonssrv.appspot.com/x.downloadServlet";
