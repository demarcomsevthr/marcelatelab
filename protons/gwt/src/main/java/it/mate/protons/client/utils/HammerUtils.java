...
public class HammerUtils {
  ...
  private static native void jsMakeDraggableImpl(Element element, JSOCallback callback) /*-{
    var offset = @it.mate.protons.client.utils.HammerUtils::getOffsetImpl(Lcom/google/gwt/dom/client/Element;D)(element, 0.5);
    var dragHandler = $entry(function(event) {
//    @it.mate.protons.client.utils.HammerUtils::log(Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)('event = ', event);
  ...
  private static native void jsCloneElementOnTouch(Element element, ElementCallback callback) /*-{
    ...
    var jsHandler = $entry(function(event) {
      ...
      callback.@it.mate.protons.client.utils.HammerUtils.ElementCallback::handle(Lcom/google/gwt/dom/client/Element;)(clonedElem);
    });
